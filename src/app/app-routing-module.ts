...
const routes: Routes = [
  ...
  { path: 'insurance-services', component: InsuranceServices, data: { metaPage: 'insuranceServices' } },
  ...
  { path: 'our-locations', component: OurLocations, runGuardsAndResolvers: 'always', data: { metaPage: 'ourLocations' } },
  ...
  { path: 'request-a-custom-quote', component: GetCustomQuote, data: { metaPage: 'getCustomQuote' } },
  { path: 'auto-insurance/quote', component: GetAutoQuote, data: { metaPage: 'getAutoQuote' } },
  { path: 'homeowners-insurance/quote', component: GetHomeQuote, data: { metaPage: 'getHomeQuote' } },
  { path: 'commercial-insurance/quote', component: GetCommercialQuote, data: { metaPage: 'getCommercialQuote' } },
...

  {
    ...
    children: [
      ...
      { path: 'family-health-insurance', component: FamilyHealthInsurance, data: { metaPage: 'familyHealthInsurance' } },
      { path: 'small-business-health-insurance', component: SmallBusinessHealthInsurance, data: { metaPage: 'smallBusinessHealthInsurance' } },
      { path: 'medicare-supplement-medigap-insurance', component: MedicareSupplementInsurance, data: { metaPage: 'medicareSupplementInsurance' } },
      { path: 'dental-vision-insurance', component: DentalVisionInsurance, data: { metaPage: 'dentalVisionInsurance' } },
      { path: 'short-term-health-insurance', component: ShortTermHealthInsurance, data: { metaPage: 'shortTermHealthInsurance' } },
      { path: 'individual-health-insurance', component: IndividualHealthInsurance, data: { metaPage: 'individualHealthInsurance' } },
      { path: 'employer-group-health-insurance', component: EmployerGroupHealthInsurance, data: { metaPage: 'employerGroupHealthInsurance' } },
      { path: 'travel-health-insurance', component: TravelHealthInsurance, data: { metaPage: 'travelHealthInsurance' } },
      { path: 'aca-marketplace-plans', component: AcaMarketplacePlansInsurance, data: { metaPage: 'acaMarketplacePlans' } },
    ]
  },
...

  {
    ...
    children: [
      ...
      { path: 'whole-life-insurance', component: WholeLifeInsurance, data: { metaPage: 'wholeLifeInsurance' } },
      { path: 'universal-life-insurance', component: UniversalLifeInsurance, data: { metaPage: 'universalLifeInsurance' } },
      { path: 'final-expense-insurance', component: FinalExpenseInsurance, data: { metaPage: 'finalExpenseInsurance' } },
      { path: 'term-life-insurance', component: TermLifeInsurance, data: { metaPage: 'termLifeInsurance' } },
      { path: 'group-life-insurance', component: GroupLifeInsurance, data: { metaPage: 'groupLifeInsurance' } },
      { path: 'variable-life-insurance', component: VariableLifeInsurance, data: { metaPage: 'variableLifeInsurance' } },
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'motorcycle-insurance', component: MotorcycleInsurance, data: { metaPage: 'motorcycleInsurance' } },
      ...
      { path: 'classic-car-insurance', component: ClassicCarInsurance, data: { metaPage: 'classicCarInsurance' } },
      { path: 'sr-22-insurance', component: Sr22Insurance, data: { metaPage: 'sr22Insurance' } },
      { path: 'atv-utv-insurance', component: AtvAndUtvInsurance, data: { metaPage: 'atvAndUtvInsurance' } },
...

  {
    ...
    children: [
      ...
      { path: 'renters-insurance', component: RentersInsurance, data: { metaPage: 'rentersInsurance' } },
      { path: 'condo-insurance', component: CondoInsurance, data: { metaPage: 'condoInsurance' } },
      { path: 'manufactured-mobile-home-insurance', component: ManufacturedMobileHomeInsurance, data: { metaPage: 'manufacturedMobileHomeInsurance' } },
      { path: 'landlord-insurance', component: LandlordInsurance, data: { metaPage: 'landlordInsurance' } },
      { path: 'earthquake-insurance', component: EarthquakeInsurance, data: { metaPage: 'earthquakeInsurance' } },
...

  {
    ...
    children: [
      ...
      { path: 'professional-liability-insurance', component: ProfessionalLiabilityInsurance, data: { metaPage: 'professionalLiabilityInsurance' } },
      { path: 'general-liability-insurance', component: GeneralLiabilityInsurance, data: { metaPage: 'generalLiabilityInsurance' } },
      { path: 'workers-compensation-insurance', component: WorkersCompensationInsurance, data: { metaPage: 'workersCompensationInsurance' } },
      { path: 'commercial-property-insurance', component: CommercialPropertyInsurance, data: { metaPage: 'commercialPropertyInsurance' } },
      { path: 'commercial-auto-insurance', component: CommercialAutoInsurance, data: { metaPage: 'commercialAutoInsurance' } },
      { path: 'business-owners-policy-bop', component: BusinessOwnerInsurance, data: { metaPage: 'businessOwnersPolicyBOP' } },
      { path: 'employment-practices-liability-insurance-epli', component: EmploymentPracticesLiabilityInsurance, data: { metaPage: 'employmentPracticesLiabilityInsuranceEPLI' } },
      { path: 'cyber-liability-insurance', component: CyberLiabilityInsurance, data: { metaPage: 'cyberLiabilityInsurance' } },
      { path: 'builders-risk-construction-insurance', component: BuildersRiskInsurance, data: { metaPage: 'buildersRiskConstructionInsurance' } },
      { path: 'directors-officers-liability-insurance-do', component: DirectorsOfficersLiabilityInsurance, data: { metaPage: 'directorsOfficersLiabilityInsuranceDO' } },
  ...
  // Spanish
  {
    ...
    children: [
      ...
      { path: 'servicios-de-seguros', component: InsuranceServices, data: { metaPage: 'insuranceServices' } },
      ...
      { path: 'solicitar-una-cotizacion-personalizada', component: GetCustomQuote, data: { metaPage: 'getCustomQuote' } },
      { path: 'seguros-de-auto/cotizacion', component: GetAutoQuote, data: { metaPage: 'getAutoQuote' } },
      { path: 'seguros-de-vivienda/cotizacion', component: GetHomeQuote, data: { metaPage: 'getHomeQuote' } },
      { path: 'seguros-comerciales/cotizacion', component: GetCommercialQuote, data: { metaPage: 'getCommercialQuote' } },
      { path: 'seguros-de-vida/cotizacion', component: GetLifeQuote, data: { metaPage: 'getLifeQuote' } },
      { path: 'seguros-de-salud/cotizacion', component: GetHealthQuote, data: { metaPage: 'getHealthQuote' } },
      { path: 'fianzas/cotizacion', component: GetSuretyQuote, data: { metaPage: 'getSuretyQuote' } },

      {
        ...
        children: [
          ...
          { path: 'seguro-de-motocicleta', component: MotorcycleInsurance, data: { metaPage: 'motorcycleInsurance' } },
          { path: 'seguro-de-bote', component: BoatInsurance, data: { metaPage: 'boatInsurance' } },
          { path: 'seguro-de-rv-y-motorhome', component: RvInsurance, data: { metaPage: 'rvInsurance' } },
          { path: 'seguro-de-auto-clasico', component: ClassicCarInsurance, data: { metaPage: 'classicCarInsurance' } },
          { path: 'seguro-sr-22', component: Sr22Insurance, data: { metaPage: 'sr22Insurance' } },
          { path: 'seguro-para-atv-y-utv', component: AtvAndUtvInsurance, data: { metaPage: 'atvAndUtvInsurance' } },
      ...
      },
      {
        ...
        children: [
          { path: '', component: HomeInsurance, data: { metaPage: 'homeInsurance' } },
          { path: 'seguros-para-inquilinos', component: RentersInsurance, data: { metaPage: 'rentersInsurance' } },
          { path: 'seguros-para-condominios', component: CondoInsurance, data: { metaPage: 'condoInsurance' } },
          { path: 'seguros-para-casas-prefabricadas-y-movil', component: ManufacturedMobileHomeInsurance, data: { metaPage: 'manufacturedMobileHomeInsurance' } },
          { path: 'seguros-para-propietarios', component: LandlordInsurance, data: { metaPage: 'landlordInsurance' } },
          { path: 'seguros-contra-terremotos', component: EarthquakeInsurance, data: { metaPage: 'earthquakeInsurance' } },
          { path: 'seguros-contra-inundaciones', component: FloodInsurance, data: { metaPage: 'floodInsurance' } },
        ]
      },
      {
        ...
        children: [
          { path: '', component: CommercialInsurance, data: { metaPage: 'commercialInsurance' } },
          { path: 'seguro-de-responsabilidad-profesional-eo', component: ProfessionalLiabilityInsurance, data: { metaPage: 'professionalLiabilityInsurance' } },
          { path: 'seguro-de-responsabilidad-general', component: GeneralLiabilityInsurance, data: { metaPage: 'generalLiabilityInsurance' } },
          { path: 'seguro-de-compensacion-laboral', component: WorkersCompensationInsurance, data: { metaPage: 'workersCompensationInsurance' } },
          { path: 'seguro-de-propiedad-comercial', component: CommercialPropertyInsurance, data: { metaPage: 'commercialPropertyInsurance' } },
          { path: 'seguro-de-auto-comercial', component: CommercialAutoInsurance, data: { metaPage: 'commercialAutoInsurance' } },
          { path: 'seguro-de-propietarios-de-negocios-bop', component: BusinessOwnerInsurance, data: { metaPage: 'businessOwnersPolicyBOP' } },
          { path: 'seguro-de-responsabilidad-de-practicas-laborales-epli', component: EmploymentPracticesLiabilityInsurance, data: { metaPage: 'employmentPracticesLiabilityInsuranceEPLI' } },
          { path: 'seguro-de-responsabilidad-cibernetica', component: CyberLiabilityInsurance, data: { metaPage: 'cyberLiabilityInsurance' } },
          { path: 'seguro-contra-riesgos-de-construccion', component: BuildersRiskInsurance, data: { metaPage: 'buildersRiskConstructionInsurance' } },
          { path: 'seguro-de-responsabilidad-de-directores-y-oficiales-do', component: DirectorsOfficersLiabilityInsurance, data: { metaPage: 'directorsOfficersLiabilityInsuranceDO' } },
        ]
      },
      {
        ...
        children: [
          { path: '', component: LifeInsurance, data: { metaPage: 'lifeInsurance' } },
          { path: 'seguro-de-vida-entero', component: WholeLifeInsurance, data: { metaPage: 'wholeLifeInsurance' } },
          { path: 'seguro-de-vida-universal', component: UniversalLifeInsurance, data: { metaPage: 'universalLifeInsurance' } },
          { path: 'seguro-de-gastos-finales', component: FinalExpenseInsurance, data: { metaPage: 'finalExpenseInsurance' } },
          { path: 'seguro-de-vida-a-plazo', component: TermLifeInsurance, data: { metaPage: 'termLifeInsurance' } },
          { path: 'seguro-de-vida-grupal', component: GroupLifeInsurance, data: { metaPage: 'groupLifeInsurance' } },
          { path: 'seguro-de-vida-variable', component: VariableLifeInsurance, data: { metaPage: 'variableLifeInsurance' } },
      ...
      },
      {
        ...
        children: [
          { path: '', component: HealthInsurance, data: { metaPage: 'healthInsurance' } },
          { path: 'seguro-de-salud-familiar', component: FamilyHealthInsurance, data: { metaPage: 'familyHealthInsurance' } },
          { path: 'seguro-de-salud-para-pequenos-negocios', component: SmallBusinessHealthInsurance, data: { metaPage: 'smallBusinessHealthInsurance' } },
          { path: 'seguro-medicare-suplementario-medigap', component: MedicareSupplementInsurance, data: { metaPage: 'medicareSupplementInsurance' } },
          { path: 'seguro-dental-y-de-vision', component: DentalVisionInsurance, data: { metaPage: 'dentalVisionInsurance' } },
          { path: 'seguro-de-salud-a-corto-plazo', component: ShortTermHealthInsurance, data: { metaPage: 'shortTermHealthInsurance' } },
          { path: 'seguro-de-salud-individual', component: IndividualHealthInsurance, data: { metaPage: 'individualHealthInsurance' } },
          { path: 'seguro-de-salud-para-empleadores-y-grupos', component: EmployerGroupHealthInsurance, data: { metaPage: 'employerGroupHealthInsurance' } },
          { path: 'seguro-de-salud-para-viajes', component: TravelHealthInsurance, data: { metaPage: 'travelHealthInsurance' } },
          { path: 'planes-aca-mercado-de-seguros', component: AcaMarketplacePlansInsurance, data: { metaPage: 'acaMarketplacePlans' } },
      ...
      { path: 'nuestras-ubicaciones/707-shotwell-st-a-houston-tx-77020', component: LocationDetail, runGuardsAndResolvers: 'always', data: { metaPage: 'location_707-shotwell-st-a-houston-tx-77020' } },
      { path: 'nuestras-ubicaciones/11503-southwest-fwy-b-houston-tx-77031', component: LocationDetail, runGuardsAndResolvers: 'always', data: { metaPage: 'location_11503-southwest-fwy-b-houston-tx-77031' } },
      { path: 'nuestras-ubicaciones/10547-s-post-oak-rd-houston-tx-77035', component: LocationDetail, runGuardsAndResolvers: 'always', data: { metaPage: 'location_10547-s-post-oak-rd-houston-tx-77035' } },
