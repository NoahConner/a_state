...
export class DallasTx implements AfterViewInit {
  ...
  monthlyRates = [
    { company: '<a class="company-name inline-link" href="https://texasfarmbureau.org/" rel="nofollow" target="_blank">Texas Farm Bureau</a>', minimum: '$44', fullCoverage: '$106' },
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/?akredirect=true" rel="nofollow" target="_blank">USAA</a>', minimum: '$47', fullCoverage: '$125' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', minimum: '$50', fullCoverage: '$124' },
    { company: '<a class="company-name inline-link" href="https://www.geico.com/" rel="nofollow" target="_blank">Geico</a>', minimum: '$71', fullCoverage: '$169' },
    { company: '<a class="company-name inline-link" href="https://www.progressive.com/" rel="nofollow" target="_blank">Progressive</a>', minimum: '$99', fullCoverage: '$258' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', minimum: '$110', fullCoverage: '$287' },
  ];

  zipRateRows = [
    { zipCode: '75287', neighborhood: 'Far North Dallas', monthlyRate: '$269', highlighted: false },
    { zipCode: '75206', neighborhood: 'Lower Greenville', monthlyRate: '$302', highlighted: true },
    { zipCode: '75231', neighborhood: 'Vickery Meadow', monthlyRate: '$320', highlighted: false },
    { zipCode: '75228', neighborhood: 'Casa View', monthlyRate: '$321', highlighted: true },
    { zipCode: '75243', neighborhood: 'Lake Highlands', monthlyRate: '$323', highlighted: false },
    { zipCode: '75220', neighborhood: 'Preston Hollow', monthlyRate: '$326', highlighted: true },
    { zipCode: '75216', neighborhood: 'Cedar Crest', monthlyRate: '$327', highlighted: false },
    { zipCode: '75227', neighborhood: 'Parkdale', monthlyRate: '$328', highlighted: true },
    { zipCode: '75211', neighborhood: 'Oak Cliff', monthlyRate: '$330', highlighted: false },
    { zipCode: '75217', neighborhood: 'Pleasant Grove', monthlyRate: '$333', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('DALLAS_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('DALLAS_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('DALLAS_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('DALLAS_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('DALLAS_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('DALLAS_TX.NEIGHBORHOODS.ROWS');
  }
