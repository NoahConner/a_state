...
@Component({
  selector: 'app-mesquite-tx',
  standalone: false,
  templateUrl: './mesquite-tx.html',
  styleUrl: './mesquite-tx.scss',
})
export class MesquiteTx implements AfterViewInit {
  ...
  monthlyRates = [
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/?akredirect=true" rel="nofollow" target="_blank">USAA</a>', minimum: '$55', fullCoverage: '$171' },
    { company: '<a class="company-name inline-link" href="https://texasfarmbureau.org/" rel="nofollow" target="_blank">Texas Farm Bureau</a>', minimum: '$58', fullCoverage: '$152' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', minimum: '$59', fullCoverage: '$157' },
    { company: '<a class="company-name inline-link" href="https://www.redpointinsurance.com/" rel="nofollow" target="_blank">Redpoint County Mutual</a>', minimum: '$62', fullCoverage: '$181' },
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', minimum: '$71', fullCoverage: '$144' },
    { company: '<a class="company-name inline-link" href="https://www.aaa.com/" rel="nofollow" target="_blank">AAA</a>', minimum: '$80', fullCoverage: '$218' },
    { company: '<a class="company-name inline-link" href="https://www.progressive.com/" rel="nofollow" target="_blank">Progressive</a>', minimum: '$81', fullCoverage: '$229' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', minimum: '$170', fullCoverage: '$493' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', minimum: '$175', fullCoverage: '$455' },
  ];

  zipRateRows = [
    { zipCode: '75043', neighborhood: 'Garland', monthlyRate: '$56', highlighted: false },
    { zipCode: '75180', neighborhood: 'Balch Springs', monthlyRate: '$130', highlighted: true },
    { zipCode: '75150', neighborhood: 'Mesquite (North)', monthlyRate: '$159', highlighted: false },
    { zipCode: '75149', neighborhood: 'Mesquite (Central)', monthlyRate: '$167', highlighted: true },
    { zipCode: '75181', neighborhood: 'Mesquite (Southeast)', monthlyRate: '$178', highlighted: false },
    { zipCode: '76308', neighborhood: 'Wichita Falls', monthlyRate: '$445', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('MESQUITE_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('MESQUITE_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('MESQUITE_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('MESQUITE_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('MESQUITE_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('MESQUITE_TX.NEIGHBORHOODS.ROWS');
  }
