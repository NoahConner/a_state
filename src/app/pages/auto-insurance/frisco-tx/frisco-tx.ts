...
@Component({
  selector: 'app-frisco-tx',
  standalone: false,
  templateUrl: './frisco-tx.html',
  styleUrl: './frisco-tx.scss',
})
export class FriscoTx implements AfterViewInit {
  ...
  zipRateRows = [
    { zipCode: '75038', neighborhood: 'Las Colinas', monthlyRate: '$87', highlighted: false },
    { zipCode: '75034', neighborhood: 'The Trails', monthlyRate: '$169', highlighted: true },
    { zipCode: '75035', neighborhood: 'Plantation Resort', monthlyRate: '$186', highlighted: false },
    { zipCode: '75220', neighborhood: 'Preston Hollow', monthlyRate: '$211', highlighted: true },
    { zipCode: '75070', neighborhood: 'Stonebridge Ranch', monthlyRate: '$271', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('FRISCO_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('FRISCO_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('FRISCO_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('FRISCO_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('FRISCO_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('FRISCO_TX.NEIGHBORHOODS.ROWS');
  }
