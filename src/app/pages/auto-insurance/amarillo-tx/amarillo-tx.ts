...
@Component({
  selector: 'app-amarillo-tx',
  standalone: false,
  templateUrl: './amarillo-tx.html',
  styleUrl: './amarillo-tx.scss',
})
export class AmarilloTx implements AfterViewInit {
  ...
  monthlyRates = [
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/?akredirect=true" rel="nofollow" target="_blank">USAA</a>', minimum: '$52', fullCoverage: '$162' },
    { company: '<a class="company-name inline-link" href="https://texasfarmbureau.org/" rel="nofollow" target="_blank">Texas Farm Bureau</a>', minimum: '$55', fullCoverage: '$143' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', minimum: '$56', fullCoverage: '$148' },
    { company: '<a class="company-name inline-link" href="https://www.redpointinsurance.com/" rel="nofollow" target="_blank">Redpoint County Mutual</a>', minimum: '$59', fullCoverage: '$171' },
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', minimum: '$67', fullCoverage: '$136' },
    { company: '<a class="company-name inline-link" href="https://www.aaa.com/" rel="nofollow" target="_blank">AAA</a>', minimum: '$75', fullCoverage: '$206' },
    { company: '<a class="company-name inline-link" href="https://www.progressive.com/" rel="nofollow" target="_blank">Progressive</a>', minimum: '$76', fullCoverage: '$216' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', minimum: '$161', fullCoverage: '$466' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', minimum: '$166', fullCoverage: '$430' },
  ];

  zipRateRows = [
    { zipCode: '79108', neighborhood: 'River Road', monthlyRate: '$111', highlighted: false },
    { zipCode: '79109', neighborhood: 'South Amarillo', monthlyRate: '$124', highlighted: true },
    { zipCode: '79119', neighborhood: 'Greenways', monthlyRate: '$128', highlighted: false },
    { zipCode: '79110', neighborhood: 'Hollywood Road', monthlyRate: '$128', highlighted: true },
    { zipCode: '79107', neighborhood: 'North Amarillo', monthlyRate: '$132', highlighted: false },
    { zipCode: '79106', neighborhood: 'San Jacinto', monthlyRate: '$136', highlighted: true },
    { zipCode: '79124', neighborhood: 'West Amarillo', monthlyRate: '$146', highlighted: false },
    { zipCode: '79103', neighborhood: 'East Amarillo', monthlyRate: '$154', highlighted: true },
    { zipCode: '79118', neighborhood: 'Tradewind', monthlyRate: '$197', highlighted: false },
    { zipCode: '79102', neighborhood: 'Wolflin', monthlyRate: '$233', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('AMARILLO_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('AMARILLO_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('AMARILLO_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('AMARILLO_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('AMARILLO_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('AMARILLO_TX.NEIGHBORHOODS.ROWS');
  }
