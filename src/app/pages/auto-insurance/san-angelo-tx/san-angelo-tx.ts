...
@Component({
  selector: 'app-san-angelo-tx',
  standalone: false,
  templateUrl: './san-angelo-tx.html',
  styleUrl: './san-angelo-tx.scss',
})
export class SanAngeloTx implements AfterViewInit {
  ...
  monthlyRates = [
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/?akredirect=true" rel="nofollow" target="_blank">USAA</a>', minimum: '$42', fullCoverage: '$130' },
    { company: '<a class="company-name inline-link" href="https://texasfarmbureau.org/" rel="nofollow" target="_blank">Texas Farm Bureau</a>', minimum: '$44', fullCoverage: '$115' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', minimum: '$45', fullCoverage: '$120' },
    { company: '<a class="company-name inline-link" href="https://www.redpointinsurance.com/" rel="nofollow" target="_blank">Redpoint County Mutual</a>', minimum: '$47', fullCoverage: '$138' },
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', minimum: '$54', fullCoverage: '$110' },
    { company: '<a class="company-name inline-link" href="https://www.aaa.com/" rel="nofollow" target="_blank">AAA</a>', minimum: '$61', fullCoverage: '$166' },
    { company: '<a class="company-name inline-link" href="https://www.progressive.com/" rel="nofollow" target="_blank">Progressive</a>', minimum: '$61', fullCoverage: '$174' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', minimum: '$129', fullCoverage: '$375' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', minimum: '$134', fullCoverage: '$346' },
  ];

  zipRateRows = [
    { zipCode: '76902', neighborhood: 'San Angelo PO Boxes', monthlyRate: '$76', highlighted: false },
    { zipCode: '76903', neighborhood: 'Downtown San Angelo', monthlyRate: '$110', highlighted: true },
    { zipCode: '76904', neighborhood: 'Southwest San Angelo', monthlyRate: '$112', highlighted: false },
    { zipCode: '76909', neighborhood: 'Angelo State University', monthlyRate: '$118', highlighted: true },
    { zipCode: '76905', neighborhood: 'East San Angelo', monthlyRate: '$119', highlighted: false },
    { zipCode: '76901', neighborhood: 'North San Angelo', monthlyRate: '$145', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('SAN_ANGELO_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('SAN_ANGELO_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('SAN_ANGELO_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('SAN_ANGELO_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('SAN_ANGELO_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('SAN_ANGELO_TX.NEIGHBORHOODS.ROWS');
  }
