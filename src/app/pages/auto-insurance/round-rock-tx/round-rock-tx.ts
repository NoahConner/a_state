...
@Component({
  selector: 'app-round-rock-tx',
  standalone: false,
  templateUrl: './round-rock-tx.html',
  styleUrl: './round-rock-tx.scss',
})
export class RoundRockTx implements AfterViewInit {
  ...
  monthlyRates = [
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/?akredirect=true" rel="nofollow" target="_blank">USAA</a>', minimum: '$49', fullCoverage: '$152' },
    { company: '<a class="company-name inline-link" href="https://texasfarmbureau.org/" rel="nofollow" target="_blank">Texas Farm Bureau</a>', minimum: '$51', fullCoverage: '$135' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', minimum: '$52', fullCoverage: '$140' },
    { company: '<a class="company-name inline-link" href="https://www.redpointinsurance.com/" rel="nofollow" target="_blank">Redpoint County Mutual</a>', minimum: '$55', fullCoverage: '$161' },
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', minimum: '$63', fullCoverage: '$128' },
    { company: '<a class="company-name inline-link" href="https://www.aaa.com/" rel="nofollow" target="_blank">AAA</a>', minimum: '$71', fullCoverage: '$194' },
    { company: '<a class="company-name inline-link" href="https://www.progressive.com/" rel="nofollow" target="_blank">Progressive</a>', minimum: '$72', fullCoverage: '$204' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', minimum: '$151', fullCoverage: '$438' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', minimum: '$156', fullCoverage: '$404' },
  ];

  zipRateRows = [
    { zipCode: '76544', neighborhood: 'Fort Cavazos', monthlyRate: '$86', highlighted: false },
    { zipCode: '78665', neighborhood: 'Round Rock Northeast', monthlyRate: '$138', highlighted: true },
    { zipCode: '78681', neighborhood: 'Round Rock West', monthlyRate: '$154', highlighted: false },
    { zipCode: '78664', neighborhood: 'Round Rock East', monthlyRate: '$165', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('ROUND_ROCK_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('ROUND_ROCK_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('ROUND_ROCK_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('ROUND_ROCK_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('ROUND_ROCK_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('ROUND_ROCK_TX.NEIGHBORHOODS.ROWS');
  }
