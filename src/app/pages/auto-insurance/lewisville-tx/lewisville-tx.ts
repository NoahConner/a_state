...
@Component({
  selector: 'app-lewisville-tx',
  standalone: false,
  templateUrl: './lewisville-tx.html',
  styleUrl: './lewisville-tx.scss',
})
export class LewisvilleTx implements AfterViewInit {
  ...
  zipRateRows = [
    { zipCode: '75287', neighborhood: 'Far North Dallas', monthlyRate: '$55', highlighted: false },
    { zipCode: '75028', neighborhood: 'Flower Mound', monthlyRate: '$76', highlighted: true },
    { zipCode: '75057', neighborhood: 'Lewisville', monthlyRate: '$141', highlighted: false },
    { zipCode: '75077', neighborhood: 'Highland Village', monthlyRate: '$150', highlighted: true },
    { zipCode: '75067', neighborhood: 'South Lewisville', monthlyRate: '$158', highlighted: false },
    { zipCode: '75056', neighborhood: 'The Colony', monthlyRate: '$271', highlighted: true },
    { zipCode: '77077', neighborhood: 'Energy Corridor', monthlyRate: '$563', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('LEWISVILLE_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('LEWISVILLE_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('LEWISVILLE_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('LEWISVILLE_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('LEWISVILLE_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('LEWISVILLE_TX.NEIGHBORHOODS.ROWS');
  }
