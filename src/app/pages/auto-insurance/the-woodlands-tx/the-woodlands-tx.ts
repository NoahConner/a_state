...
@Component({
  selector: 'app-the-woodlands-tx',
  standalone: false,
  templateUrl: './the-woodlands-tx.html',
  styleUrl: './the-woodlands-tx.scss',
})
export class TheWoodlandsTx implements AfterViewInit {
  ...
  zipRateRows = [
    { zipCode: '77384', neighborhood: 'College Park', monthlyRate: '$155', highlighted: false },
    { zipCode: '77382', neighborhood: 'Alden Bridge', monthlyRate: '$156', highlighted: true },
    { zipCode: '77381', neighborhood: 'Panther Creek', monthlyRate: '$157', highlighted: false },
    { zipCode: '77380', neighborhood: 'Town Center', monthlyRate: '$158', highlighted: true },
    { zipCode: '77385', neighborhood: 'Oak Ridge North', monthlyRate: '$159', highlighted: false },
    { zipCode: '77354', neighborhood: 'Magnolia', monthlyRate: '$162', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('THE_WOODLANDS_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('THE_WOODLANDS_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('THE_WOODLANDS_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('THE_WOODLANDS_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('THE_WOODLANDS_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('THE_WOODLANDS_TX.NEIGHBORHOODS.ROWS');
  }
