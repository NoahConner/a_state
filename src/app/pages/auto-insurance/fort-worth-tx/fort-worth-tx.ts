...
@Component({
  selector: 'app-fort-worth-tx',
  standalone: false,
  templateUrl: './fort-worth-tx.html',
  styleUrl: './fort-worth-tx.scss',
})
export class FortWorthTx implements AfterViewInit {
  ...
  monthlyRates = [
    { company: '<a class="company-name inline-link" href="https://texasfarmbureau.org/" rel="nofollow" target="_blank">Texas Farm Bureau</a>', minimum: '$34', fullCoverage: '$88' },
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/?akredirect=true" rel="nofollow" target="_blank">USAA</a>', minimum: '$41', fullCoverage: '$107' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', minimum: '$47', fullCoverage: '$113' },
    { company: '<a class="company-name inline-link" href="https://www.progressive.com/" rel="nofollow" target="_blank">Progressive</a>', minimum: '$59', fullCoverage: '$221' },
    { company: '<a class="company-name inline-link" href="https://www.geico.com/" rel="nofollow" target="_blank">Geico</a>', minimum: '$67', fullCoverage: '$169' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', minimum: '$74', fullCoverage: '$181' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', minimum: '$158', fullCoverage: '$401' },
  ];

  zipRateRows = [
    { zipCode: '76112', neighborhood: 'Woodhaven', monthlyRate: '$277', highlighted: false },
    { zipCode: '76116', neighborhood: 'Ridglea', monthlyRate: '$279', highlighted: true },
    { zipCode: '76137', neighborhood: 'Summerfields', monthlyRate: '$280', highlighted: false },
    { zipCode: '76108', neighborhood: 'White Settlement', monthlyRate: '$282', highlighted: true },
    { zipCode: '76123', neighborhood: 'Willow Creek', monthlyRate: '$284', highlighted: false },
    { zipCode: '76133', neighborhood: 'Wedgewood', monthlyRate: '$285', highlighted: true },
    { zipCode: '76119', neighborhood: 'Polytechnic', monthlyRate: '$286', highlighted: false },
    { zipCode: '76179', neighborhood: 'Saginaw', monthlyRate: '$286', highlighted: true },
    { zipCode: '76106', neighborhood: 'Stockyards', monthlyRate: '$291', highlighted: false },
    { zipCode: '76131', neighborhood: 'Blue Mound', monthlyRate: '$295', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('FORT_WORTH_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('FORT_WORTH_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('FORT_WORTH_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('FORT_WORTH_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('FORT_WORTH_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('FORT_WORTH_TX.NEIGHBORHOODS.ROWS');
  }
