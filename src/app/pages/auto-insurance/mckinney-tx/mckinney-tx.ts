...
@Component({
  selector: 'app-mckinney-tx',
  standalone: false,
  templateUrl: './mckinney-tx.html',
  styleUrl: './mckinney-tx.scss',
})
export class MckinneyTx implements AfterViewInit {
  ...
  zipRateRows = [
    { zipCode: '75069', neighborhood: 'Historic District', monthlyRate: '$140', highlighted: false },
    { zipCode: '75071', neighborhood: 'Trinity Falls', monthlyRate: '$158', highlighted: true },
    { zipCode: '75070', neighborhood: 'Stonebridge Ranch', monthlyRate: '$187', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('MCKINNEY_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('MCKINNEY_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('MCKINNEY_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('MCKINNEY_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('MCKINNEY_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('MCKINNEY_TX.NEIGHBORHOODS.ROWS');
  }
