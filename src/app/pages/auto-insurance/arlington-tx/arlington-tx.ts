...
@Component({
  selector: 'app-arlington-tx',
  standalone: false,
  templateUrl: './arlington-tx.html',
  styleUrl: './arlington-tx.scss',
})
export class ArlingtonTx implements AfterViewInit {
  ...
  monthlyRates = [
    { company: '<a class="company-name inline-link" href="https://www.geico.com/" rel="nofollow" target="_blank">Geico</a>', minimum: '$49', fullCoverage: '$130' },
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/?akredirect=true" rel="nofollow" target="_blank">USAA</a>', minimum: '$56', fullCoverage: '$151' },
    { company: '<a class="company-name inline-link" href="https://texasfarmbureau.org/" rel="nofollow" target="_blank">Texas Farm Bureau</a>', minimum: '$56', fullCoverage: '$146' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', minimum: '$61', fullCoverage: '$213' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', minimum: '$69', fullCoverage: '$141' },
    { company: '<a class="company-name inline-link" href="https://www.nationwide.com/" rel="nofollow" target="_blank">Nationwide</a>', minimum: '$73', fullCoverage: '$136' },
    { company: '<a class="company-name inline-link" href="https://www.progressive.com/" rel="nofollow" target="_blank">Progressive</a>', minimum: '$79', fullCoverage: '$201' },
  ];

  zipRateRows = [
    { zipCode: '76012', neighborhood: 'Interlochen', monthlyRate: '$275', highlighted: false },
    { zipCode: '76001', neighborhood: 'Southwest Arlington', monthlyRate: '$283', highlighted: true },
    { zipCode: '76017', neighborhood: 'Oakwood', monthlyRate: '$285', highlighted: false },
    { zipCode: '76013', neighborhood: 'Pantego', monthlyRate: '$285', highlighted: true },
    { zipCode: '76016', neighborhood: 'Dalworthington Gardens', monthlyRate: '$285', highlighted: false },
    { zipCode: '76006', neighborhood: 'Viridian', monthlyRate: '$288', highlighted: true },
    { zipCode: '76014', neighborhood: 'Shorewood', monthlyRate: '$289', highlighted: false },
    { zipCode: '76018', neighborhood: 'Southeast Arlington', monthlyRate: '$291', highlighted: true },
    { zipCode: '76002', neighborhood: 'Mayfield', monthlyRate: '$292', highlighted: false },
    { zipCode: '76010', neighborhood: 'Downtown Arlington', monthlyRate: '$304', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('ARLINGTON_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('ARLINGTON_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('ARLINGTON_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('ARLINGTON_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('ARLINGTON_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('ARLINGTON_TX.NEIGHBORHOODS.ROWS');
  }
