...
@Component({
  selector: 'app-richardson-tx',
  standalone: false,
  templateUrl: './richardson-tx.html',
  styleUrl: './richardson-tx.scss',
})
export class RichardsonTx implements AfterViewInit {
  ...
  zipRateRows = [
    { zipCode: '75083', neighborhood: 'Richardson Northwest', monthlyRate: '$124', highlighted: false },
    { zipCode: '75081', neighborhood: 'Richardson Southeast', monthlyRate: '$166', highlighted: true },
    { zipCode: '75082', neighborhood: 'Richardson Northeast', monthlyRate: '$179', highlighted: false },
    { zipCode: '75080', neighborhood: 'Richardson Southwest', monthlyRate: '$211', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('RICHARDSON_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('RICHARDSON_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('RICHARDSON_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('RICHARDSON_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('RICHARDSON_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('RICHARDSON_TX.NEIGHBORHOODS.ROWS');
  }
