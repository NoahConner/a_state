...
@Component({
  selector: 'app-conroe-tx',
  standalone: false,
  templateUrl: './conroe-tx.html',
  styleUrl: './conroe-tx.scss',
})
export class ConroeTx implements AfterViewInit {
  ...
  monthlyRates = [
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/?akredirect=true" rel="nofollow" target="_blank">USAA</a>', minimum: '$52', fullCoverage: '$163' },
    { company: '<a class="company-name inline-link" href="https://texasfarmbureau.org/" rel="nofollow" target="_blank">Texas Farm Bureau</a>', minimum: '$55', fullCoverage: '$145' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', minimum: '$56', fullCoverage: '$150' },
    { company: '<a class="company-name inline-link" href="https://www.redpointinsurance.com/" rel="nofollow" target="_blank">Redpoint County Mutual</a>', minimum: '$59', fullCoverage: '$173' },
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', minimum: '$68', fullCoverage: '$137' },
    { company: '<a class="company-name inline-link" href="https://www.aaa.com/" rel="nofollow" target="_blank">AAA</a>', minimum: '$76', fullCoverage: '$208' },
    { company: '<a class="company-name inline-link" href="https://www.progressive.com/" rel="nofollow" target="_blank">Progressive</a>', minimum: '$77', fullCoverage: '$218' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', minimum: '$162', fullCoverage: '$470' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', minimum: '$167', fullCoverage: '$434' },
  ];

  zipRateRows = [
    { zipCode: '77386', neighborhood: 'Spring', monthlyRate: '$98', highlighted: false },
    { zipCode: '77303', neighborhood: 'Conroe East', monthlyRate: '$131', highlighted: true },
    { zipCode: '77385', neighborhood: 'Oak Ridge North', monthlyRate: '$132', highlighted: false },
    { zipCode: '77302', neighborhood: 'Conroe Southeast', monthlyRate: '$149', highlighted: true },
    { zipCode: '77301', neighborhood: 'Conroe Downtown', monthlyRate: '$154', highlighted: false },
    { zipCode: '77384', neighborhood: 'Conroe Southwest', monthlyRate: '$156', highlighted: true },
    { zipCode: '77304', neighborhood: 'Conroe West', monthlyRate: '$178', highlighted: false },
    { zipCode: '77306', neighborhood: 'Conroe Northeast', monthlyRate: '$189', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('CONROE_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('CONROE_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('CONROE_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('CONROE_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('CONROE_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('CONROE_TX.NEIGHBORHOODS.ROWS');
  }
