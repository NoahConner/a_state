...
@Component({
  selector: 'app-grand-prairie-tx',
  standalone: false,
  templateUrl: './grand-prairie-tx.html',
  styleUrl: './grand-prairie-tx.scss',
})
export class GrandPrairieTx implements AfterViewInit {
  ...
  zipRateRows = [
    { zipCode: '75052', neighborhood: 'Westchester', monthlyRate: '$167', highlighted: false },
    { zipCode: '75051', neighborhood: 'High Hawk', monthlyRate: '$177', highlighted: true },
    { zipCode: '75050', neighborhood: 'Burbank Gardens', monthlyRate: '$177', highlighted: false },
    { zipCode: '75054', neighborhood: 'Mirabella', monthlyRate: '$207', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('GRAND_PRAIRIE_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('GRAND_PRAIRIE_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('GRAND_PRAIRIE_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('GRAND_PRAIRIE_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('GRAND_PRAIRIE_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('GRAND_PRAIRIE_TX.NEIGHBORHOODS.ROWS');
  }
