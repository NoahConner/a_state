...
@Component({
  selector: 'app-mcallen-tx',
  standalone: false,
  templateUrl: './mcallen-tx.html',
  styleUrl: './mcallen-tx.scss',
})
export class McallenTx implements AfterViewInit {
  ...
  zipRateRows = [
    { zipCode: '78503', neighborhood: 'McAllen (South)', monthlyRate: '$155', highlighted: false },
    { zipCode: '78504', neighborhood: 'McAllen (North)', monthlyRate: '$163', highlighted: true },
    { zipCode: '78501', neighborhood: 'McAllen (Central)', monthlyRate: '$185', highlighted: false },
    { zipCode: '78502', neighborhood: 'McAllen (West)', monthlyRate: '$193', highlighted: true },
    { zipCode: '78574', neighborhood: 'Mission', monthlyRate: '$228', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('MCALLEN_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('MCALLEN_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('MCALLEN_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('MCALLEN_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('MCALLEN_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('MCALLEN_TX.NEIGHBORHOODS.ROWS');
  }
