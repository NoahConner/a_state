...
@Component({
  selector: 'app-allen-tx',
  standalone: false,
  templateUrl: './allen-tx.html',
  styleUrl: './allen-tx.scss',
})
export class AllenTx implements AfterViewInit {
  ...
  monthlyRates = [
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/?akredirect=true" rel="nofollow" target="_blank">USAA</a>', minimum: '$53', fullCoverage: '$165' },
    ...
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', minimum: '$57', fullCoverage: '$151' },
    { company: '<a class="company-name inline-link" href="https://www.redpointinsurance.com/" rel="nofollow" target="_blank">Redpoint County Mutual</a>', minimum: '$60', fullCoverage: '$174' },
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', minimum: '$68', fullCoverage: '$139' },
    { company: '<a class="company-name inline-link" href="https://www.aaa.com/" rel="nofollow" target="_blank">AAA</a>', minimum: '$77', fullCoverage: '$210' },
    { company: '<a class="company-name inline-link" href="https://www.progressive.com/" rel="nofollow" target="_blank">Progressive</a>', minimum: '$78', fullCoverage: '$221' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', minimum: '$164', fullCoverage: '$475' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', minimum: '$169', fullCoverage: '$438' },
  ];

  zipRateRows = [
    { zipCode: '75013', neighborhood: 'West Allen', monthlyRate: '$148', highlighted: false },
    { zipCode: '75002', neighborhood: 'East Allen', monthlyRate: '$168', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('ALLEN_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('ALLEN_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('ALLEN_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('ALLEN_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('ALLEN_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('ALLEN_TX.NEIGHBORHOODS.ROWS');
  }
