...
@Component({
  selector: 'app-odessa-tx',
  standalone: false,
  templateUrl: './odessa-tx.html',
  styleUrl: './odessa-tx.scss',
})
export class OdessaTx implements AfterViewInit {
  ...
  monthlyRates = [
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/?akredirect=true" rel="nofollow" target="_blank">USAA</a>', minimum: '$51', fullCoverage: '$160' },
    { company: '<a class="company-name inline-link" href="https://texasfarmbureau.org/" rel="nofollow" target="_blank">Texas Farm Bureau</a>', minimum: '$54', fullCoverage: '$142' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', minimum: '$55', fullCoverage: '$147' },
    { company: '<a class="company-name inline-link" href="https://www.redpointinsurance.com/" rel="nofollow" target="_blank">Redpoint County Mutual</a>', minimum: '$58', fullCoverage: '$169' },
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', minimum: '$66', fullCoverage: '$135' },
    { company: '<a class="company-name inline-link" href="https://www.aaa.com/" rel="nofollow" target="_blank">AAA</a>', minimum: '$74', fullCoverage: '$204' },
    { company: '<a class="company-name inline-link" href="https://www.progressive.com/" rel="nofollow" target="_blank">Progressive</a>', minimum: '$75', fullCoverage: '$214' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', minimum: '$159', fullCoverage: '$461' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', minimum: '$164', fullCoverage: '$425' },
  ];

  zipRateRows = [
    { zipCode: '79758', neighborhood: 'Gardendale', monthlyRate: '$97', highlighted: false },
    { zipCode: '79763', neighborhood: 'West Odessa', monthlyRate: '$143', highlighted: true },
    { zipCode: '79764', neighborhood: 'Northwest Odessa', monthlyRate: '$172', highlighted: false },
    { zipCode: '79762', neighborhood: 'Northeast Odessa', monthlyRate: '$181', highlighted: true },
    { zipCode: '79761', neighborhood: 'Downtown Odessa', monthlyRate: '$185', highlighted: false },
    { zipCode: '79765', neighborhood: 'East Odessa', monthlyRate: '$192', highlighted: true },
    { zipCode: '79766', neighborhood: 'South Odessa', monthlyRate: '$265', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('ODESSA_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('ODESSA_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('ODESSA_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('ODESSA_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('ODESSA_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('ODESSA_TX.NEIGHBORHOODS.ROWS');
  }
