...
@Component({
  selector: 'app-temple-tx',
  standalone: false,
  templateUrl: './temple-tx.html',
  styleUrl: './temple-tx.scss',
})
export class TempleTx implements AfterViewInit {
  ...
  zipRateRows = [
    { zipCode: '76501', neighborhood: 'Temple Downtown', monthlyRate: '$103', highlighted: false },
    { zipCode: '76504', neighborhood: 'Temple North', monthlyRate: '$136', highlighted: true },
    { zipCode: '76502', neighborhood: 'Temple South', monthlyRate: '$142', highlighted: false },
    { zipCode: '76547', neighborhood: 'Fort Cavazos', monthlyRate: '$186', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('TEMPLE_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('TEMPLE_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('TEMPLE_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('TEMPLE_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('TEMPLE_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('TEMPLE_TX.NEIGHBORHOODS.ROWS');
  }
