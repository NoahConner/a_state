...
@Component({
  selector: 'app-georgetown-tx',
  standalone: false,
  templateUrl: './georgetown-tx.html',
  styleUrl: './georgetown-tx.scss',
})
export class GeorgetownTx implements AfterViewInit {
  ...
  zipRateRows = [
    { zipCode: '78633', neighborhood: 'Georgetown North', monthlyRate: '$105', highlighted: false },
    { zipCode: '78628', neighborhood: 'Georgetown West', monthlyRate: '$114', highlighted: true },
    { zipCode: '78626', neighborhood: 'Georgetown East', monthlyRate: '$127', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('GEORGETOWN_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('GEORGETOWN_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('GEORGETOWN_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('GEORGETOWN_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('GEORGETOWN_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('GEORGETOWN_TX.NEIGHBORHOODS.ROWS');
  }
