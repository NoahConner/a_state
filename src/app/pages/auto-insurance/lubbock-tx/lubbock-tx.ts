...
@Component({
  selector: 'app-lubbock-tx',
  standalone: false,
  templateUrl: './lubbock-tx.html',
  styleUrl: './lubbock-tx.scss',
})
export class LubbockTx implements AfterViewInit {
  ...
  monthlyRates = [
    { company: '<a class="company-name inline-link" href="https://www.geico.com/" rel="nofollow" target="_blank">Geico</a>', minimum: '$40', fullCoverage: '$112' },
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/?akredirect=true" rel="nofollow" target="_blank">USAA</a>', minimum: '$47', fullCoverage: '$159' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', minimum: '$52', fullCoverage: '$222' },
    { company: '<a class="company-name inline-link" href="https://texasfarmbureau.org/" rel="nofollow" target="_blank">Texas Farm Bureau</a>', minimum: '$55', fullCoverage: '$141' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', minimum: '$60', fullCoverage: '$130' },
    { company: '<a class="company-name inline-link" href="https://www.nationwide.com/" rel="nofollow" target="_blank">Nationwide</a>', minimum: '$65', fullCoverage: '$127' },
    { company: '<a class="company-name inline-link" href="https://www.progressive.com/" rel="nofollow" target="_blank">Progressive</a>', minimum: '$72', fullCoverage: '$229' },
  ];

  zipRateRows = [
    { zipCode: '79424', neighborhood: 'Kings Park', monthlyRate: '$129', highlighted: false },
    { zipCode: '79412', neighborhood: 'Clapp Park', monthlyRate: '$132', highlighted: true },
    { zipCode: '79413', neighborhood: 'Heart of Lubbock', monthlyRate: '$134', highlighted: false },
    { zipCode: '79415', neighborhood: 'Guadalupe', monthlyRate: '$137', highlighted: true },
    { zipCode: '79407', neighborhood: 'West End', monthlyRate: '$138', highlighted: false },
    { zipCode: '79403', neighborhood: 'Parkway', monthlyRate: '$163', highlighted: true },
    { zipCode: '79414', neighborhood: 'Maxey Park', monthlyRate: '$170', highlighted: false },
    { zipCode: '79423', neighborhood: 'Lakeridge', monthlyRate: '$176', highlighted: true },
    { zipCode: '79404', neighborhood: 'Chatman Hill', monthlyRate: '$184', highlighted: false },
    { zipCode: '79416', neighborhood: 'Northwest', monthlyRate: '$200', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('LUBBOCK_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('LUBBOCK_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('LUBBOCK_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('LUBBOCK_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('LUBBOCK_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('LUBBOCK_TX.NEIGHBORHOODS.ROWS');
  }
