...
@Component({
  selector: 'app-wichita-falls-tx',
  standalone: false,
  templateUrl: './wichita-falls-tx.html',
  styleUrl: './wichita-falls-tx.scss',
})
export class WichitaFallsTx implements AfterViewInit {
  ...
  monthlyRates = [
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/?akredirect=true" rel="nofollow" target="_blank">USAA</a>', minimum: '$41', fullCoverage: '$129' },
    { company: '<a class="company-name inline-link" href="https://texasfarmbureau.org/" rel="nofollow" target="_blank">Texas Farm Bureau</a>', minimum: '$43', fullCoverage: '$114' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', minimum: '$44', fullCoverage: '$118' },
    { company: '<a class="company-name inline-link" href="https://www.redpointinsurance.com/" rel="nofollow" target="_blank">Redpoint County Mutual</a>', minimum: '$47', fullCoverage: '$136' },
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', minimum: '$53', fullCoverage: '$108' },
    { company: '<a class="company-name inline-link" href="https://www.aaa.com/" rel="nofollow" target="_blank">AAA</a>', minimum: '$60', fullCoverage: '$164' },
    { company: '<a class="company-name inline-link" href="https://www.progressive.com/" rel="nofollow" target="_blank">Progressive</a>', minimum: '$61', fullCoverage: '$172' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', minimum: '$128', fullCoverage: '$371' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', minimum: '$132', fullCoverage: '$342' },
  ];

  zipRateRows = [
    { zipCode: '76301', neighborhood: 'Downtown Wichita Falls', monthlyRate: '$104', highlighted: false },
    { zipCode: '76308', neighborhood: 'Southwest Wichita Falls', monthlyRate: '$115', highlighted: true },
    { zipCode: '76309', neighborhood: 'West Wichita Falls', monthlyRate: '$119', highlighted: false },
    { zipCode: '76302', neighborhood: 'Southeast Wichita Falls', monthlyRate: '$128', highlighted: true },
    { zipCode: '76306', neighborhood: 'North Wichita Falls', monthlyRate: '$134', highlighted: false },
    { zipCode: '76305', neighborhood: 'Northeast Wichita Falls', monthlyRate: '$135', highlighted: true },
    { zipCode: '76310', neighborhood: 'South Wichita Falls', monthlyRate: '$140', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('WICHITA_FALLS_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('WICHITA_FALLS_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('WICHITA_FALLS_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('WICHITA_FALLS_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('WICHITA_FALLS_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('WICHITA_FALLS_TX.NEIGHBORHOODS.ROWS');
  }
