...
@Component({
  selector: 'app-san-antonio-tx',
  standalone: false,
  templateUrl: './san-antonio-tx.html',
  styleUrl: './san-antonio-tx.scss',
})
export class SanAntonioTx implements AfterViewInit {
  ...
  monthlyRates = [
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/?akredirect=true" rel="nofollow" target="_blank">USAA</a>', minimum: '$109', fullCoverage: '$286' },
    { company: '<a class="company-name inline-link" href="https://texasfarmbureau.org/" rel="nofollow" target="_blank">Texas Farm Bureau</a>', minimum: '$112', fullCoverage: '$253' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', minimum: '$223', fullCoverage: '$500' },
    { company: '<a class="company-name inline-link" href="https://www.progressive.com/" rel="nofollow" target="_blank">Progressive</a>', minimum: '$256', fullCoverage: '$757' },
    { company: '<a class="company-name inline-link" href="https://www.geico.com/" rel="nofollow" target="_blank">Geico</a>', minimum: '$275', fullCoverage: '$599' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', minimum: '$330', fullCoverage: '$741' },
  ];

  zipRateRows = [
    { zipCode: '78253', neighborhood: 'Alamo Ranch', monthlyRate: '$292', highlighted: false },
    { zipCode: '78254', neighborhood: 'Shaenfield', monthlyRate: '$296', highlighted: true },
    { zipCode: '78251', neighborhood: 'Westover Hills', monthlyRate: '$297', highlighted: false },
    { zipCode: '78250', neighborhood: 'Northwest Crossing', monthlyRate: '$300', highlighted: true },
    { zipCode: '78240', neighborhood: 'Oakland Estates', monthlyRate: '$300', highlighted: false },
    { zipCode: '78223', neighborhood: 'Brooks', monthlyRate: '$302', highlighted: true },
    { zipCode: '78228', neighborhood: 'Woodlawn Hills', monthlyRate: '$302', highlighted: false },
    { zipCode: '78207', neighborhood: 'Prospect Hill', monthlyRate: '$305', highlighted: true },
    { zipCode: '78249', neighborhood: 'University City', monthlyRate: '$306', highlighted: false },
    { zipCode: '78245', neighborhood: 'Adams Hill', monthlyRate: '$307', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('SAN_ANTONIO_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('SAN_ANTONIO_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('SAN_ANTONIO_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('SAN_ANTONIO_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('SAN_ANTONIO_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('SAN_ANTONIO_TX.NEIGHBORHOODS.ROWS');
  }
