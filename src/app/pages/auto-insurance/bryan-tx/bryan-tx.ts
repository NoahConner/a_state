...
@Component({
  selector: 'app-bryan-tx',
  standalone: false,
  templateUrl: './bryan-tx.html',
  styleUrl: './bryan-tx.scss',
})
export class BryanTx implements AfterViewInit {
  ...
  zipRateRows = [
    { zipCode: '78572', neighborhood: 'Mission', monthlyRate: '$120', highlighted: false },
    { zipCode: '77807', neighborhood: 'Bryan West', monthlyRate: '$128', highlighted: true },
    { zipCode: '77803', neighborhood: 'Bryan North', monthlyRate: '$135', highlighted: false },
    { zipCode: '77802', neighborhood: 'Bryan East', monthlyRate: '$138', highlighted: true },
    { zipCode: '77801', neighborhood: 'Bryan Central', monthlyRate: '$140', highlighted: false },
    { zipCode: '77808', neighborhood: 'Bryan Northeast', monthlyRate: '$159', highlighted: true },
    { zipCode: '77845', neighborhood: 'College Station South', monthlyRate: '$181', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('BRYAN_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('BRYAN_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('BRYAN_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('BRYAN_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('BRYAN_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('BRYAN_TX.NEIGHBORHOODS.ROWS');
  }
