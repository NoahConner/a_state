...
@Component({
  selector: 'app-pasadena-tx',
  standalone: false,
  templateUrl: './pasadena-tx.html',
  styleUrl: './pasadena-tx.scss',
})
export class PasadenaTx implements AfterViewInit {
  ...
  monthlyRates = [
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/?akredirect=true" rel="nofollow" target="_blank">USAA</a>', minimum: '$60', fullCoverage: '$187' },
    { company: '<a class="company-name inline-link" href="https://texasfarmbureau.org/" rel="nofollow" target="_blank">Texas Farm Bureau</a>', minimum: '$63', fullCoverage: '$165' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', minimum: '$64', fullCoverage: '$171' },
    { company: '<a class="company-name inline-link" href="https://www.redpointinsurance.com/" rel="nofollow" target="_blank">Redpoint County Mutual</a>', minimum: '$68', fullCoverage: '$198' },
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', minimum: '$77', fullCoverage: '$157' },
    { company: '<a class="company-name inline-link" href="https://www.aaa.com/" rel="nofollow" target="_blank">AAA</a>', minimum: '$87', fullCoverage: '$238' },
    { company: '<a class="company-name inline-link" href="https://www.progressive.com/" rel="nofollow" target="_blank">Progressive</a>', minimum: '$88', fullCoverage: '$250' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', minimum: '$186', fullCoverage: '$538' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', minimum: '$192', fullCoverage: '$496' },
  ];

  zipRateRows = [
    { zipCode: '77503', neighborhood: 'Pasadena (North)', monthlyRate: '$157', highlighted: false },
    { zipCode: '77502', neighborhood: 'Pasadena (Central)', monthlyRate: '$162', highlighted: true },
    { zipCode: '77507', neighborhood: 'Pasadena (Bayport)', monthlyRate: '$174', highlighted: false },
    { zipCode: '77505', neighborhood: 'Pasadena (South)', monthlyRate: '$176', highlighted: true },
    { zipCode: '77504', neighborhood: 'Pasadena (Southeast)', monthlyRate: '$181', highlighted: false },
    { zipCode: '77506', neighborhood: 'Pasadena (Northwest)', monthlyRate: '$194', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('PASADENA_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('PASADENA_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('PASADENA_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('PASADENA_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('PASADENA_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('PASADENA_TX.NEIGHBORHOODS.ROWS');
  }
