...
@Component({
  selector: 'app-college-station-tx',
  standalone: false,
  templateUrl: './college-station-tx.html',
  styleUrl: './college-station-tx.scss',
})
export class CollegeStationTx implements AfterViewInit {
  ...
  zipRateRows = [
    { zipCode: '78840', neighborhood: 'Del Rio', monthlyRate: '$41', highlighted: false },
    { zipCode: '77801', neighborhood: 'Downtown Bryan', monthlyRate: '$66', highlighted: true },
    { zipCode: '77843', neighborhood: 'Texas A&M University', monthlyRate: '$71', highlighted: false },
    { zipCode: '77845', neighborhood: 'South College Station', monthlyRate: '$138', highlighted: true },
    { zipCode: '77840', neighborhood: 'College Station', monthlyRate: '$160', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('COLLEGE_STATION_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('COLLEGE_STATION_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('COLLEGE_STATION_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('COLLEGE_STATION_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('COLLEGE_STATION_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('COLLEGE_STATION_TX.NEIGHBORHOODS.ROWS');
  }
