...
@Component({
  selector: 'app-garland-tx',
  standalone: false,
  templateUrl: './garland-tx.html',
  styleUrl: './garland-tx.scss',
})
export class GarlandTx implements AfterViewInit {
  ...
  monthlyRates = [
    { company: '<a class="company-name inline-link" href="https://www.redpointinsurance.com/" rel="nofollow" target="_blank">Redpoint County Mutual</a>', minimum: '$127', fullCoverage: '$127' },
    { company: '<a class="company-name inline-link" href="https://germaniainsurance.com/" rel="nofollow" target="_blank">Germania Mutual Group</a>', minimum: '$135', fullCoverage: '$135' },
    { company: '<a class="company-name inline-link" href="https://www.geico.com/" rel="nofollow" target="_blank">Geico</a>', minimum: '$135', fullCoverage: '$135' },
    { company: '<a class="company-name inline-link" href="https://www.nationwide.com/" rel="nofollow" target="_blank">Nationwide</a>', minimum: '$144', fullCoverage: '$144' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', minimum: '$157', fullCoverage: '$157' },
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/?akredirect=true" rel="nofollow" target="_blank">USAA</a>', minimum: '$158', fullCoverage: '$158' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', minimum: '$234', fullCoverage: '$234' },
  ];

  zipRateRows = [
    { zipCode: '75228', neighborhood: 'Casa View', monthlyRate: '$74', highlighted: false },
    { zipCode: '75042', neighborhood: 'Walnut', monthlyRate: '$149', highlighted: true },
    { zipCode: '75041', neighborhood: 'South Garland', monthlyRate: '$154', highlighted: false },
    { zipCode: '75040', neighborhood: 'Coomer Creek', monthlyRate: '$159', highlighted: true },
    { zipCode: '75044', neighborhood: 'Firewheel', monthlyRate: '$175', highlighted: false },
    { zipCode: '75043', neighborhood: 'Meadowcreek', monthlyRate: '$180', highlighted: true },
    { zipCode: '75048', neighborhood: 'Sachse', monthlyRate: '$266', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('GARLAND_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('GARLAND_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('GARLAND_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('GARLAND_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('GARLAND_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('GARLAND_TX.NEIGHBORHOODS.ROWS');
  }
