...
@Component({
  selector: 'app-beaumont-tx',
  standalone: false,
  templateUrl: './beaumont-tx.html',
  styleUrl: './beaumont-tx.scss',
})
export class BeaumontTx implements AfterViewInit {
  ...
  monthlyRates = [
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/?akredirect=true" rel="nofollow" target="_blank">USAA</a>', minimum: '$55', fullCoverage: '$173' },
    { company: '<a class="company-name inline-link" href="https://texasfarmbureau.org/" rel="nofollow" target="_blank">Texas Farm Bureau</a>', minimum: '$58', fullCoverage: '$153' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', minimum: '$59', fullCoverage: '$158' },
    { company: '<a class="company-name inline-link" href="https://www.redpointinsurance.com/" rel="nofollow" target="_blank">Redpoint County Mutual</a>', minimum: '$63', fullCoverage: '$183' },
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', minimum: '$72', fullCoverage: '$145' },
    { company: '<a class="company-name inline-link" href="https://www.aaa.com/" rel="nofollow" target="_blank">AAA</a>', minimum: '$80', fullCoverage: '$220' },
    { company: '<a class="company-name inline-link" href="https://www.progressive.com/" rel="nofollow" target="_blank">Progressive</a>', minimum: '$81', fullCoverage: '$231' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', minimum: '$172', fullCoverage: '$497' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', minimum: '$177', fullCoverage: '$459' },
  ];

  zipRateRows = [
    { zipCode: '77707', neighborhood: 'Amelia', monthlyRate: '$108', highlighted: false },
    { zipCode: '77703', neighborhood: 'North End', monthlyRate: '$139', highlighted: true },
    { zipCode: '77713', neighborhood: 'Bevil Oaks', monthlyRate: '$144', highlighted: false },
    { zipCode: '77708', neighborhood: 'Pine Island', monthlyRate: '$148', highlighted: true },
    { zipCode: '77706', neighborhood: 'West End', monthlyRate: '$155', highlighted: false },
    { zipCode: '77701', neighborhood: 'Downtown Beaumont', monthlyRate: '$172', highlighted: true },
    { zipCode: '77705', neighborhood: 'South End', monthlyRate: '$191', highlighted: false },
    { zipCode: '77702', neighborhood: 'Old Agency', monthlyRate: '$202', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('BEAUMONT_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('BEAUMONT_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('BEAUMONT_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('BEAUMONT_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('BEAUMONT_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('BEAUMONT_TX.NEIGHBORHOODS.ROWS');
  }
