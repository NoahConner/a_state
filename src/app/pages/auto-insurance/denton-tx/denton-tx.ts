...
@Component({
  selector: 'app-denton-tx',
  standalone: false,
  templateUrl: './denton-tx.html',
  styleUrl: './denton-tx.scss',
})
export class DentonTx implements AfterViewInit {
  ...
  monthlyRates = [
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', minimum: '$42', fullCoverage: '$82' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', minimum: '$59', fullCoverage: '$116' },
    { company: '<a class="company-name inline-link" href="https://www.mileauto.com/" rel="nofollow" target="_blank">Mile Auto</a>', minimum: '$61', fullCoverage: '$135' },
    { company: '<a class="company-name inline-link" href="https://www.progressive.com/" rel="nofollow" target="_blank">Progressive</a>', minimum: '$61', fullCoverage: '$113' },
    { company: '<a class="company-name inline-link" href="https://www.geico.com/" rel="nofollow" target="_blank">GEICO</a>', minimum: '$68', fullCoverage: '$142' },
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/?akredirect=true" rel="nofollow" target="_blank">USAA</a>', minimum: '$75', fullCoverage: '$147' },
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', minimum: '$83', fullCoverage: '$134' },
    { company: '<a class="company-name inline-link" href="https://www.firstacceptance.com/" rel="nofollow" target="_blank">First Acceptance</a>', minimum: '$85', fullCoverage: '$209' },
    { company: '<a class="company-name inline-link" href="https://www.thegeneral.com/" rel="nofollow" target="_blank">The General</a>', minimum: '$88', fullCoverage: '$196' },
    { company: '<a class="company-name inline-link" href="https://www.alinsco.com/" rel="nofollow" target="_blank">Alinsco</a>', minimum: '$89', fullCoverage: '$174' },
  ];

  zipRateRows = [
    { zipCode: '75035', neighborhood: 'Frisco', monthlyRate: '$56', highlighted: false },
    { zipCode: '76208', neighborhood: 'Denton (East)', monthlyRate: '$148', highlighted: true },
    { zipCode: '76205', neighborhood: 'Denton (South)', monthlyRate: '$154', highlighted: false },
    { zipCode: '76201', neighborhood: 'Denton (Central)', monthlyRate: '$159', highlighted: true },
    { zipCode: '76210', neighborhood: 'Denton (Southwest)', monthlyRate: '$170', highlighted: false },
    { zipCode: '76207', neighborhood: 'Denton (Northwest)', monthlyRate: '$176', highlighted: true },
    { zipCode: '76209', neighborhood: 'Denton (Northeast)', monthlyRate: '$191', highlighted: false },
    { zipCode: '76020', neighborhood: 'Azle', monthlyRate: '$221', highlighted: true },
    { zipCode: '76203', neighborhood: 'UNT Campus', monthlyRate: '$348', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('DENTON_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('DENTON_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('DENTON_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('DENTON_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('DENTON_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('DENTON_TX.NEIGHBORHOODS.ROWS');
  }
