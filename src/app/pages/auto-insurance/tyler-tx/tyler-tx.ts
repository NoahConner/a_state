...
@Component({
  selector: 'app-tyler-tx',
  standalone: false,
  templateUrl: './tyler-tx.html',
  styleUrl: './tyler-tx.scss',
})
export class TylerTx implements AfterViewInit {
  ...
  monthlyRates = [
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/?akredirect=true" rel="nofollow" target="_blank">USAA</a>', minimum: '$51', fullCoverage: '$159' },
    { company: '<a class="company-name inline-link" href="https://texasfarmbureau.org/" rel="nofollow" target="_blank">Texas Farm Bureau</a>', minimum: '$54', fullCoverage: '$140' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', minimum: '$55', fullCoverage: '$145' },
    { company: '<a class="company-name inline-link" href="https://www.redpointinsurance.com/" rel="nofollow" target="_blank">Redpoint County Mutual</a>', minimum: '$58', fullCoverage: '$168' },
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', minimum: '$66', fullCoverage: '$133' },
    { company: '<a class="company-name inline-link" href="https://www.aaa.com/" rel="nofollow" target="_blank">AAA</a>', minimum: '$74', fullCoverage: '$202' },
    { company: '<a class="company-name inline-link" href="https://www.progressive.com/" rel="nofollow" target="_blank">Progressive</a>', minimum: '$75', fullCoverage: '$212' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', minimum: '$158', fullCoverage: '$457' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', minimum: '$163', fullCoverage: '$421' },
  ];

  zipRateRows = [
    { zipCode: '75711', neighborhood: 'Flint', monthlyRate: '$85', highlighted: false },
    { zipCode: '75707', neighborhood: 'East Tyler', monthlyRate: '$113', highlighted: true },
    { zipCode: '75708', neighborhood: 'North Tyler', monthlyRate: '$124', highlighted: false },
    { zipCode: '75701', neighborhood: 'Midtown', monthlyRate: '$144', highlighted: true },
    { zipCode: '75702', neighborhood: 'Downtown Tyler', monthlyRate: '$144', highlighted: false },
    { zipCode: '75706', neighborhood: 'West Tyler', monthlyRate: '$152', highlighted: true },
    { zipCode: '75709', neighborhood: 'Westside', monthlyRate: '$153', highlighted: false },
    { zipCode: '75704', neighborhood: 'Northwest Tyler', monthlyRate: '$155', highlighted: true },
    { zipCode: '75705', neighborhood: 'Southeast Tyler', monthlyRate: '$189', highlighted: false },
    { zipCode: '75703', neighborhood: 'South Tyler', monthlyRate: '$199', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('TYLER_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('TYLER_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('TYLER_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('TYLER_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('TYLER_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('TYLER_TX.NEIGHBORHOODS.ROWS');
  }
