...
@Component({
  selector: 'app-baytown-tx',
  standalone: false,
  templateUrl: './baytown-tx.html',
  styleUrl: './baytown-tx.scss',
})
export class BaytownTx implements AfterViewInit {
  ...
  monthlyRates = [
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/?akredirect=true" rel="nofollow" target="_blank">USAA</a>', minimum: '$60', fullCoverage: '$188' },
    { company: '<a class="company-name inline-link" href="https://texasfarmbureau.org/" rel="nofollow" target="_blank">Texas Farm Bureau</a>', minimum: '$64', fullCoverage: '$167' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', minimum: '$65', fullCoverage: '$173' },
    { company: '<a class="company-name inline-link" href="https://www.redpointinsurance.com/" rel="nofollow" target="_blank">Redpoint County Mutual</a>', minimum: '$68', fullCoverage: '$199' },
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', minimum: '$78', fullCoverage: '$158' },
    { company: '<a class="company-name inline-link" href="https://www.aaa.com/" rel="nofollow" target="_blank">AAA</a>', minimum: '$88', fullCoverage: '$240' },
    { company: '<a class="company-name inline-link" href="https://www.progressive.com/" rel="nofollow" target="_blank">Progressive</a>', minimum: '$89', fullCoverage: '$252' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', minimum: '$187', fullCoverage: '$542' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', minimum: '$193', fullCoverage: '$500' },
  ];

  zipRateRows = [
    { zipCode: '77520', neighborhood: 'Baytown West', monthlyRate: '$178', highlighted: false },
    { zipCode: '77521', neighborhood: 'Baytown North', monthlyRate: '$188', highlighted: true },
    { zipCode: '77523', neighborhood: 'Mont Belvieu', monthlyRate: '$190', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('BAYTOWN_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('BAYTOWN_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('BAYTOWN_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('BAYTOWN_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('BAYTOWN_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('BAYTOWN_TX.NEIGHBORHOODS.ROWS');
  }
