...
@Component({
  selector: 'app-league-city-tx',
  standalone: false,
  templateUrl: './league-city-tx.html',
  styleUrl: './league-city-tx.scss',
})
export class LeagueCityTx implements AfterViewInit {
  ...
  zipRateRows = [
    { zipCode: '77573', neighborhood: 'League City', monthlyRate: '$144', highlighted: false },
    { zipCode: '77539', neighborhood: 'Dickinson', monthlyRate: '$218', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('LEAGUE_CITY_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('LEAGUE_CITY_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('LEAGUE_CITY_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('LEAGUE_CITY_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('LEAGUE_CITY_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('LEAGUE_CITY_TX.NEIGHBORHOODS.ROWS');
  }
