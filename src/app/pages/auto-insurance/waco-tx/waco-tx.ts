...
@Component({
  selector: 'app-waco-tx',
  standalone: false,
  templateUrl: './waco-tx.html',
  styleUrl: './waco-tx.scss',
})
export class WacoTx implements AfterViewInit {
  ...
  monthlyRates = [
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/?akredirect=true" rel="nofollow" target="_blank">USAA</a>', minimum: '$47', fullCoverage: '$148' },
    { company: '<a class="company-name inline-link" href="https://texasfarmbureau.org/" rel="nofollow" target="_blank">Texas Farm Bureau</a>', minimum: '$50', fullCoverage: '$131' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', minimum: '$51', fullCoverage: '$135' },
    { company: '<a class="company-name inline-link" href="https://www.redpointinsurance.com/" rel="nofollow" target="_blank">Redpoint County Mutual</a>', minimum: '$54', fullCoverage: '$156' },
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', minimum: '$61', fullCoverage: '$124' },
    { company: '<a class="company-name inline-link" href="https://www.aaa.com/" rel="nofollow" target="_blank">AAA</a>', minimum: '$69', fullCoverage: '$188' },
    { company: '<a class="company-name inline-link" href="https://www.progressive.com/" rel="nofollow" target="_blank">Progressive</a>', minimum: '$70', fullCoverage: '$197' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', minimum: '$147', fullCoverage: '$425' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', minimum: '$151', fullCoverage: '$392' },
  ];

  zipRateRows = [
    { zipCode: '76078', neighborhood: 'Rhome', monthlyRate: '$61', highlighted: false },
    { zipCode: '76714', neighborhood: 'Woodway', monthlyRate: '$63', highlighted: true },
    { zipCode: '76701', neighborhood: 'Downtown Waco', monthlyRate: '$102', highlighted: false },
    { zipCode: '76708', neighborhood: 'North Waco', monthlyRate: '$103', highlighted: true },
    { zipCode: '76707', neighborhood: 'West Waco', monthlyRate: '$112', highlighted: false },
    { zipCode: '76710', neighborhood: 'Heart of Texas', monthlyRate: '$114', highlighted: true },
    { zipCode: '76712', neighborhood: 'Hewitt', monthlyRate: '$115', highlighted: false },
    { zipCode: '76706', neighborhood: 'South Waco', monthlyRate: '$116', highlighted: true },
    { zipCode: '76705', neighborhood: 'East Waco', monthlyRate: '$140', highlighted: false },
    { zipCode: '76704', neighborhood: 'Carver', monthlyRate: '$145', highlighted: true },
    { zipCode: '76711', neighborhood: 'Oakwood', monthlyRate: '$145', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('WACO_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('WACO_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('WACO_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('WACO_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('WACO_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('WACO_TX.NEIGHBORHOODS.ROWS');
  }
