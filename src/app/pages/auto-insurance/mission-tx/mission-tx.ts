...
@Component({
  selector: 'app-mission-tx',
  standalone: false,
  templateUrl: './mission-tx.html',
  styleUrl: './mission-tx.scss',
})
export class MissionTx implements AfterViewInit {
  ...
  monthlyRates = [
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/?akredirect=true" rel="nofollow" target="_blank">USAA</a>', minimum: '$58', fullCoverage: '$182' },
    { company: '<a class="company-name inline-link" href="https://texasfarmbureau.org/" rel="nofollow" target="_blank">Texas Farm Bureau</a>', minimum: '$61', fullCoverage: '$161' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', minimum: '$63', fullCoverage: '$167' },
    { company: '<a class="company-name inline-link" href="https://www.redpointinsurance.com/" rel="nofollow" target="_blank">Redpoint County Mutual</a>', minimum: '$66', fullCoverage: '$193' },
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', minimum: '$75', fullCoverage: '$153' },
    { company: '<a class="company-name inline-link" href="https://www.aaa.com/" rel="nofollow" target="_blank">AAA</a>', minimum: '$85', fullCoverage: '$232' },
    { company: '<a class="company-name inline-link" href="https://www.progressive.com/" rel="nofollow" target="_blank">Progressive</a>', minimum: '$86', fullCoverage: '$244' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', minimum: '$181', fullCoverage: '$524' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', minimum: '$187', fullCoverage: '$484' },
  ];

  zipRateRows = [
    { zipCode: '78389', neighborhood: 'Skidmore', monthlyRate: '$104', highlighted: false },
    { zipCode: '78573', neighborhood: 'Mission North', monthlyRate: '$131', highlighted: true },
    { zipCode: '78572', neighborhood: 'Mission', monthlyRate: '$153', highlighted: false },
    { zipCode: '78574', neighborhood: 'Palmview', monthlyRate: '$203', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('MISSION_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('MISSION_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('MISSION_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('MISSION_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('MISSION_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('MISSION_TX.NEIGHBORHOODS.ROWS');
  }
