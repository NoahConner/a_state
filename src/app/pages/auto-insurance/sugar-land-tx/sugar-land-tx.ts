...
@Component({
  selector: 'app-sugar-land-tx',
  standalone: false,
  templateUrl: './sugar-land-tx.html',
  styleUrl: './sugar-land-tx.scss',
})
export class SugarLandTx implements AfterViewInit {
  ...
  monthlyRates = [
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/?akredirect=true" rel="nofollow" target="_blank">USAA</a>', minimum: '$56', fullCoverage: '$177' },
    { company: '<a class="company-name inline-link" href="https://texasfarmbureau.org/" rel="nofollow" target="_blank">Texas Farm Bureau</a>', minimum: '$60', fullCoverage: '$157' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', minimum: '$61', fullCoverage: '$163' },
    { company: '<a class="company-name inline-link" href="https://www.redpointinsurance.com/" rel="nofollow" target="_blank">Redpoint County Mutual</a>', minimum: '$64', fullCoverage: '$188' },
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', minimum: '$73', fullCoverage: '$149' },
    { company: '<a class="company-name inline-link" href="https://www.aaa.com/" rel="nofollow" target="_blank">AAA</a>', minimum: '$82', fullCoverage: '$226' },
    { company: '<a class="company-name inline-link" href="https://www.progressive.com/" rel="nofollow" target="_blank">Progressive</a>', minimum: '$84', fullCoverage: '$237' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', minimum: '$176', fullCoverage: '$511' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', minimum: '$182', fullCoverage: '$471' },
  ];

  zipRateRows = [
    { zipCode: '77083', neighborhood: 'Alief', monthlyRate: '$131', highlighted: false },
    { zipCode: '77479', neighborhood: 'Greatwood', monthlyRate: '$152', highlighted: true },
    { zipCode: '77459', neighborhood: 'Missouri City', monthlyRate: '$171', highlighted: false },
    { zipCode: '77498', neighborhood: 'Town Center', monthlyRate: '$187', highlighted: true },
    { zipCode: '77478', neighborhood: 'First Colony', monthlyRate: '$210', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('SUGAR_LAND_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('SUGAR_LAND_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('SUGAR_LAND_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('SUGAR_LAND_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('SUGAR_LAND_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('SUGAR_LAND_TX.NEIGHBORHOODS.ROWS');
  }
