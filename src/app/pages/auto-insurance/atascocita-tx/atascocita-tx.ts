...
@Component({
  selector: 'app-atascocita-tx',
  standalone: false,
  templateUrl: './atascocita-tx.html',
  styleUrl: './atascocita-tx.scss',
})
export class AtascocitaTx implements AfterViewInit {
  ...
  monthlyRates = [
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/?akredirect=true" rel="nofollow" target="_blank">USAA</a>', minimum: '$61', fullCoverage: '$192' },
    { company: '<a class="company-name inline-link" href="https://texasfarmbureau.org/" rel="nofollow" target="_blank">Texas Farm Bureau</a>', minimum: '$65', fullCoverage: '$170' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', minimum: '$66', fullCoverage: '$176' },
    { company: '<a class="company-name inline-link" href="https://www.redpointinsurance.com/" rel="nofollow" target="_blank">Redpoint County Mutual</a>', minimum: '$70', fullCoverage: '$203' },
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', minimum: '$79', fullCoverage: '$161' },
    { company: '<a class="company-name inline-link" href="https://www.aaa.com/" rel="nofollow" target="_blank">AAA</a>', minimum: '$89', fullCoverage: '$244' },
    { company: '<a class="company-name inline-link" href="https://www.progressive.com/" rel="nofollow" target="_blank">Progressive</a>', minimum: '$90', fullCoverage: '$256' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', minimum: '$190', fullCoverage: '$551' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', minimum: '$196', fullCoverage: '$509' },
  ];

  zipRateRows = [
    { zipCode: '77346', neighborhood: 'Atascocita Central', monthlyRate: '$118', highlighted: false },
    { zipCode: '77345', neighborhood: 'Atascocita North', monthlyRate: '$124', highlighted: true },
    { zipCode: '77396', neighborhood: 'Atascocita South', monthlyRate: '$135', highlighted: false },
    { zipCode: '77338', neighborhood: 'Atascocita West', monthlyRate: '$142', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('ATASCOCITA_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('ATASCOCITA_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('ATASCOCITA_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('ATASCOCITA_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('ATASCOCITA_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('ATASCOCITA_TX.NEIGHBORHOODS.ROWS');
  }
