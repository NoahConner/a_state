...
@Component({
  selector: 'app-irving-tx',
  standalone: false,
  templateUrl: './irving-tx.html',
  styleUrl: './irving-tx.scss',
})
export class IrvingTx implements AfterViewInit {
  ...
  monthlyRates = [
    { company: '<a class="company-name inline-link" href="https://www.geico.com/" rel="nofollow" target="_blank">Geico</a>', minimum: '$49', fullCoverage: '$129' },
    { company: '<a class="company-name inline-link" href="https://germaniainsurance.com/" rel="nofollow" target="_blank">Germania Mutual Group</a>', minimum: '$53', fullCoverage: '$133' },
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/?akredirect=true" rel="nofollow" target="_blank">USAA</a>', minimum: '$58', fullCoverage: '$157' },
    { company: '<a class="company-name inline-link" href="https://www.redpointinsurance.com/" rel="nofollow" target="_blank">Redpoint County Mutual</a>', minimum: '$65', fullCoverage: '$133' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', minimum: '$68', fullCoverage: '$145' },
    { company: '<a class="company-name inline-link" href="https://www.nationwide.com/" rel="nofollow" target="_blank">Nationwide</a>', minimum: '$75', fullCoverage: '$169' },
    { company: '<a class="company-name inline-link" href="https://www.progressive.com/" rel="nofollow" target="_blank">Progressive</a>', minimum: '$79', fullCoverage: '$206' },
  ];

  zipRateRows = [
    { zipCode: '75062', neighborhood: 'Central Irving', monthlyRate: '$155', highlighted: false },
    { zipCode: '75060', neighborhood: 'South Irving', monthlyRate: '$156', highlighted: true },
    { zipCode: '75061', neighborhood: 'East Irving', monthlyRate: '$158', highlighted: false },
    { zipCode: '75039', neighborhood: 'Urban Center', monthlyRate: '$180', highlighted: true },
    { zipCode: '75063', neighborhood: 'Valley Ranch', monthlyRate: '$185', highlighted: false },
    { zipCode: '75038', neighborhood: 'Las Colinas', monthlyRate: '$191', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('IRVING_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('IRVING_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('IRVING_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('IRVING_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('IRVING_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('IRVING_TX.NEIGHBORHOODS.ROWS');
  }
