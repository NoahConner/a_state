...
@Component({
  selector: 'app-new-braunfels-tx',
  standalone: false,
  templateUrl: './new-braunfels-tx.html',
  styleUrl: './new-braunfels-tx.scss',
})
export class NewBraunfelsTx implements AfterViewInit {
  ...
  monthlyRates = [
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/?akredirect=true" rel="nofollow" target="_blank">USAA</a>', minimum: '$48', fullCoverage: '$151' },
    { company: '<a class="company-name inline-link" href="https://texasfarmbureau.org/" rel="nofollow" target="_blank">Texas Farm Bureau</a>', minimum: '$51', fullCoverage: '$133' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', minimum: '$52', fullCoverage: '$138' },
    { company: '<a class="company-name inline-link" href="https://www.redpointinsurance.com/" rel="nofollow" target="_blank">Redpoint County Mutual</a>', minimum: '$55', fullCoverage: '$159' },
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', minimum: '$62', fullCoverage: '$127' },
    { company: '<a class="company-name inline-link" href="https://www.aaa.com/" rel="nofollow" target="_blank">AAA</a>', minimum: '$70', fullCoverage: '$192' },
    { company: '<a class="company-name inline-link" href="https://www.progressive.com/" rel="nofollow" target="_blank">Progressive</a>', minimum: '$71', fullCoverage: '$202' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', minimum: '$150', fullCoverage: '$434' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', minimum: '$155', fullCoverage: '$400' },
  ];

  zipRateRows = [
    { zipCode: '78132', neighborhood: 'West New Braunfels', monthlyRate: '$101', highlighted: false },
    { zipCode: '78133', neighborhood: 'Canyon Lake', monthlyRate: '$130', highlighted: true },
    { zipCode: '78130', neighborhood: 'East New Braunfels', monthlyRate: '$137', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('NEW_BRAUNFELS_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('NEW_BRAUNFELS_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('NEW_BRAUNFELS_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('NEW_BRAUNFELS_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('NEW_BRAUNFELS_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('NEW_BRAUNFELS_TX.NEIGHBORHOODS.ROWS');
  }
