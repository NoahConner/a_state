...
@Component({
  selector: 'app-midland-tx',
  standalone: false,
  templateUrl: './midland-tx.html',
  styleUrl: './midland-tx.scss',
})
export class MidlandTx implements AfterViewInit {
  ...
  monthlyRates = [
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/?akredirect=true" rel="nofollow" target="_blank">USAA</a>', minimum: '$48', fullCoverage: '$149' },
    { company: '<a class="company-name inline-link" href="https://texasfarmbureau.org/" rel="nofollow" target="_blank">Texas Farm Bureau</a>', minimum: '$50', fullCoverage: '$132' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', minimum: '$51', fullCoverage: '$137' },
    { company: '<a class="company-name inline-link" href="https://www.redpointinsurance.com/" rel="nofollow" target="_blank">Redpoint County Mutual</a>', minimum: '$54', fullCoverage: '$158' },
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', minimum: '$62', fullCoverage: '$125' },
    { company: '<a class="company-name inline-link" href="https://www.aaa.com/" rel="nofollow" target="_blank">AAA</a>', minimum: '$69', fullCoverage: '$190' },
    { company: '<a class="company-name inline-link" href="https://www.progressive.com/" rel="nofollow" target="_blank">Progressive</a>', minimum: '$70', fullCoverage: '$200' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', minimum: '$148', fullCoverage: '$429' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', minimum: '$153', fullCoverage: '$396' },
  ];

  zipRateRows = [
    { zipCode: '79712', neighborhood: 'Greenwood', monthlyRate: '$114', highlighted: false },
    { zipCode: '79710', neighborhood: 'Midkiff', monthlyRate: '$146', highlighted: true },
    { zipCode: '79701', neighborhood: 'Downtown Midland', monthlyRate: '$149', highlighted: false },
    { zipCode: '79705', neighborhood: 'North Midland', monthlyRate: '$156', highlighted: true },
    { zipCode: '79703', neighborhood: 'West Midland', monthlyRate: '$159', highlighted: false },
    { zipCode: '79707', neighborhood: 'Grassland', monthlyRate: '$159', highlighted: true },
    { zipCode: '79706', neighborhood: 'South Midland', monthlyRate: '$174', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('MIDLAND_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('MIDLAND_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('MIDLAND_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('MIDLAND_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('MIDLAND_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('MIDLAND_TX.NEIGHBORHOODS.ROWS');
  }
