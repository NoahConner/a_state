...
@Component({
  selector: 'app-laredo-tx',
  standalone: false,
  templateUrl: './laredo-tx.html',
  styleUrl: './laredo-tx.scss',
})
export class LaredoTx implements AfterViewInit {
  ...
  monthlyRates = [
    { company: '<a class="company-name inline-link" href="https://germaniainsurance.com/" rel="nofollow" target="_blank">Germania Mutual Group</a>', minimum: '$36', fullCoverage: '$115' },
    { company: '<a class="company-name inline-link" href="https://www.geico.com/" rel="nofollow" target="_blank">Geico</a>', minimum: '$38', fullCoverage: '$128' },
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/?akredirect=true" rel="nofollow" target="_blank">USAA</a>', minimum: '$53', fullCoverage: '$155' },
    { company: '<a class="company-name inline-link" href="https://www.redpointinsurance.com/" rel="nofollow" target="_blank">Redpoint County Mutual</a>', minimum: '$55', fullCoverage: '$135' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', minimum: '$61', fullCoverage: '$149' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', minimum: '$67', fullCoverage: '$234' },
    { company: '<a class="company-name inline-link" href="https://www.nationwide.com/" rel="nofollow" target="_blank">Nationwide</a>', minimum: '$80', fullCoverage: '$166' },
  ];

  zipRateRows = [
    { zipCode: '78044', neighborhood: 'Downtown Laredo', monthlyRate: '$63', highlighted: false },
    { zipCode: '78040', neighborhood: 'El Cuatro', monthlyRate: '$152', highlighted: true },
    { zipCode: '78045', neighborhood: 'Mines Road', monthlyRate: '$156', highlighted: false },
    { zipCode: '78041', neighborhood: 'Del Mar', monthlyRate: '$159', highlighted: true },
    { zipCode: '78046', neighborhood: 'El Azteca', monthlyRate: '$169', highlighted: false },
    { zipCode: '78043', neighborhood: 'Chacon', monthlyRate: '$197', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('LAREDO_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('LAREDO_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('LAREDO_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('LAREDO_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('LAREDO_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('LAREDO_TX.NEIGHBORHOODS.ROWS');
  }
