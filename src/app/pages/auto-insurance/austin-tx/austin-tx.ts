...
@Component({
  selector: 'app-austin-tx',
  standalone: false,
  templateUrl: './austin-tx.html',
  styleUrl: './austin-tx.scss',
})
export class AustinTx implements AfterViewInit {
  ...
  monthlyRates = [
    { company: '<a class="company-name inline-link" href="https://texasfarmbureau.org/" rel="nofollow" target="_blank">Texas Farm Bureau</a>', minimum: '$37', fullCoverage: '$91' },
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/?akredirect=true" rel="nofollow" target="_blank">USAA</a>', minimum: '$41', fullCoverage: '$109' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', minimum: '$46', fullCoverage: '$110' },
    { company: '<a class="company-name inline-link" href="https://www.progressive.com/" rel="nofollow" target="_blank">Progressive</a>', minimum: '$59', fullCoverage: '$210' },
    { company: '<a class="company-name inline-link" href="https://www.geico.com/" rel="nofollow" target="_blank">Geico</a>', minimum: '$68', fullCoverage: '$162' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', minimum: '$74', fullCoverage: '$174' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', minimum: '$179', fullCoverage: '$431' },
  ];

  zipRateRows = [
    { zipCode: '78717', neighborhood: 'Avery Ranch', monthlyRate: '$258', highlighted: false },
    { zipCode: '78705', neighborhood: 'West Campus', monthlyRate: '$270', highlighted: true },
    { zipCode: '78759', neighborhood: 'Great Hills', monthlyRate: '$274', highlighted: false },
    { zipCode: '78704', neighborhood: 'South Congress', monthlyRate: '$275', highlighted: true },
    { zipCode: '78758', neighborhood: 'Quail Creek', monthlyRate: '$277', highlighted: false },
    { zipCode: '78748', neighborhood: 'Olympic Heights', monthlyRate: '$278', highlighted: true },
    { zipCode: '78745', neighborhood: 'Cherry Creek', monthlyRate: '$281', highlighted: false },
    { zipCode: '78753', neighborhood: 'North Central Austin', monthlyRate: '$287', highlighted: true },
    { zipCode: '78741', neighborhood: 'East Riverside', monthlyRate: '$287', highlighted: false },
    { zipCode: '78744', neighborhood: 'Southeast Austin', monthlyRate: '$290', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('AUSTIN_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('AUSTIN_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('AUSTIN_TX.RATES.COMPARISON_TABLE.MINIMUM'),
      ...
      },
      {
        ...
        values: [
          this.translate.instant('AUSTIN_TX.RATES.COMPARISON_TABLE.FULL_COVERAGE'),
    ...
    this.faqItems = this.translate.instant('AUSTIN_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('AUSTIN_TX.NEIGHBORHOODS.ROWS');
  }
