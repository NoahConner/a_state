...
@Component({
  selector: 'app-homeowners-grand-prairie-tx',
  standalone: false,
  templateUrl: './grand-prairie-tx.html',
  styleUrl: './grand-prairie-tx.scss',
})
export class HomeownersGrandPrairieTx implements AfterViewInit {
  ...
  annualRates = [
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', premium: '$3,450' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', premium: '$5,120' },
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/" rel="nofollow" target="_blank">USAA</a>', premium: '$5,490' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', premium: '$6,350' },
    { company: '<a class="company-name inline-link" href="https://www.chubb.com/pk-en/" rel="nofollow" target="_blank">Chubb</a>', premium: '$14,890' },
  ];

  zipRateRows = [
    { zipCode: '75050', neighborhood: 'GRAND_PRAIRIE_HOME_TX.RATES.ZIP_NEIGHBORHOOD_CENTRAL', annualCost: '$2,850', highlighted: false },
    { zipCode: '75051', neighborhood: 'GRAND_PRAIRIE_HOME_TX.RATES.ZIP_NEIGHBORHOOD_WEST', annualCost: '$3,120', highlighted: true },
    { zipCode: '75052', neighborhood: 'GRAND_PRAIRIE_HOME_TX.RATES.ZIP_NEIGHBORHOOD_SOUTH', annualCost: '$3,410', highlighted: false },
    { zipCode: '75054', neighborhood: 'GRAND_PRAIRIE_HOME_TX.RATES.ZIP_NEIGHBORHOOD_NORTH', annualCost: '$2,790', highlighted: true },
    { zipCode: '76001', neighborhood: 'GRAND_PRAIRIE_HOME_TX.RATES.ZIP_NEIGHBORHOOD_SOUTHWEST', annualCost: '$3,350', highlighted: false },
    { zipCode: '76006', neighborhood: 'GRAND_PRAIRIE_HOME_TX.RATES.ZIP_NEIGHBORHOOD_ENTERTAINMENT', annualCost: '$3,240', highlighted: true },
    { zipCode: '79109', neighborhood: 'GRAND_PRAIRIE_HOME_TX.RATES.ZIP_NEIGHBORHOOD_SOUTH', annualCost: '$5,201', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('GRAND_PRAIRIE_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('GRAND_PRAIRIE_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('GRAND_PRAIRIE_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('GRAND_PRAIRIE_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('GRAND_PRAIRIE_HOME_TX.NEIGHBORHOODS.ROWS');
  }
