...
@Component({
  selector: 'app-homeowners-lewisville-tx',
  standalone: false,
  templateUrl: './lewisville-tx.html',
  styleUrl: './lewisville-tx.scss',
})
export class HomeownersLewisvilleTx implements AfterViewInit {
  ...
  annualRates = [
    { company: '<a class="company-name inline-link" href="https://www.republicindemnity.com/" rel="nofollow" target="_blank">Republic Indemnity</a>', premium: '$1,620' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', premium: '$2,440' },
    { company: '<a class="company-name inline-link" href="https://www.travelers.com/" rel="nofollow" target="_blank">Travelers</a>', premium: '$2,440' },
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', premium: '$2,940' },
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/" rel="nofollow" target="_blank">USAA</a>', premium: '$3,180' },
    { company: '<a class="company-name inline-link" href="https://www.foremost.com/" rel="nofollow" target="_blank">Foremost</a>', premium: '$3,500' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', premium: '$3,680' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', premium: '$3,720' },
    { company: '<a class="company-name inline-link" href="https://www.nationwide.com/" rel="nofollow" target="_blank">Nationwide</a>', premium: '$5,480' },
    { company: '<a class="company-name inline-link" href="https://www.chubb.com/pk-en/" rel="nofollow" target="_blank">Chubb</a>', premium: '$7,450' },
  ];

  zipRateRows = [
    { zipCode: '75056', neighborhood: 'Castle Hills', annualCost: '$3,750', highlighted: false },
    { zipCode: '75057', neighborhood: 'Old Town', annualCost: '$3,420', highlighted: true },
    { zipCode: '75067', neighborhood: 'Lakeway', annualCost: '$3,580', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('LEWISVILLE_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('LEWISVILLE_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('LEWISVILLE_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('LEWISVILLE_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('LEWISVILLE_HOME_TX.NEIGHBORHOODS.ROWS');
  }
