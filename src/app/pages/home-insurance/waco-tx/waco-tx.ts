...
@Component({
  selector: 'app-homeowners-waco-tx',
  standalone: false,
  templateUrl: './waco-tx.html',
  styleUrl: './waco-tx.scss',
})
export class HomeownersWacoTx implements AfterViewInit {
  ...
  annualRates = [
    { company: '<a class="company-name inline-link" href="https://republicindemnity.com/" rel="nofollow" target="_blank">Republic Indemnity</a>', premium: '$1,296' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', premium: '$1,956' },
    { company: '<a class="company-name inline-link" href="https://www.travelers.co.uk/" rel="nofollow" target="_blank">Travelers</a>', premium: '$1,956' },
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', premium: '$2,352' },
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/" rel="nofollow" target="_blank">USAA</a>', premium: '$2,544' },
    { company: '<a class="company-name inline-link" href="https://www.foremost.com/insurance/home/" rel="nofollow" target="_blank">Foremost</a>', premium: '$2,796' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', premium: '$2,940' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', premium: '$2,976' },
    { company: '<a class="company-name inline-link" href="https://www.nationwide.com/" rel="nofollow" target="_blank">Nationwide</a>', premium: '$4,380' },
    { company: '<a class="company-name inline-link" href="https://www.chubb.com/uk-en/" rel="nofollow" target="_blank">Chubb</a>', premium: '$5,964' },
  ];

  zipRateRows = [
    { zipCode: '76706', neighborhood: 'South Waco', annualCost: '$3,480', highlighted: false },
    { zipCode: '76705', neighborhood: 'North Waco', annualCost: '$3,120', highlighted: true },
    { zipCode: '76708', neighborhood: 'Lake Waco', annualCost: '$3,650', highlighted: false },
    { zipCode: '76710', neighborhood: 'Central Waco', annualCost: '$3,350', highlighted: true },
    { zipCode: '76707', neighborhood: 'East Waco', annualCost: '$2,950', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('WACO_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('WACO_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('WACO_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('WACO_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('WACO_HOME_TX.NEIGHBORHOODS.ROWS');
  }
