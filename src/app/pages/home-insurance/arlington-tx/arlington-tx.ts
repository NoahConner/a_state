...
@Component({
  selector: 'app-homeowners-arlington-tx',
  standalone: false,
  templateUrl: './arlington-tx.html',
  styleUrl: './arlington-tx.scss',
})
export class HomeownersArlingtonTx implements AfterViewInit {
  ...
  annualRates = [
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/texas/" rel="nofollow" target="_blank">Texas Farmers</a>', premium: '$279' },
    { company: '<a class="company-name inline-link" href="https://www.altasurance.com/american-strategic-insurance/" rel="nofollow" target="_blank">ASI Lloyds</a>', premium: '$2,963' },
    { company: '<a class="company-name inline-link" href="https://agents.libertymutual.com/" rel="nofollow" target="_blank">Safeco</a>', premium: '$2,998' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', premium: '$3,149' },
    { company: '<a class="company-name inline-link" href="https://www.uuinsurance.com/" rel="nofollow" target="_blank">United</a>', premium: '$3,239' },
  ];

  zipRateRows = [
    { zipCode: '76119', neighborhood: 'Fort Worth', annualCost: '$3,652', highlighted: false },
    { zipCode: '76011', neighborhood: 'North Arlington', annualCost: '$3,694', highlighted: true },
    { zipCode: '76017', neighborhood: 'South Arlington', annualCost: '$3,701', highlighted: false },
    { zipCode: '76005', neighborhood: 'Viridian', annualCost: '$4,547', highlighted: true },
    { zipCode: '76014', neighborhood: 'East Arlington', annualCost: '$3,764', highlighted: false },
    { zipCode: '76018', neighborhood: 'Southeast Arlington', annualCost: '$3,755', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('ARLINGTON_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('ARLINGTON_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('ARLINGTON_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('ARLINGTON_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('ARLINGTON_HOME_TX.NEIGHBORHOODS.ROWS');
  }
