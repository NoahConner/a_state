...
@Component({
  selector: 'app-homeowners-pearland-tx',
  standalone: false,
  templateUrl: './pearland-tx.html',
  styleUrl: './pearland-tx.scss',
})
export class HomeownersPearlandTx implements AfterViewInit {
  ...
  annualRates = [
    { company: '<a class="company-name inline-link" href="https://republicindemnity.com/" rel="nofollow" target="_blank">Republic Indemnity</a>', premium: '$2,120' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', premium: '$3,190' },
    { company: '<a class="company-name inline-link" href="https://www.travelers.co.uk/" rel="nofollow" target="_blank">Travelers</a>', premium: '$3,190' },
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', premium: '$3,840' },
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/" rel="nofollow" target="_blank">USAA</a>', premium: '$4,150' },
    { company: '<a class="company-name inline-link" href="https://www.foremost.com/insurance/home/" rel="nofollow" target="_blank">Foremost</a>', premium: '$4,570' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', premium: '$4,810' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', premium: '$4,870' },
    { company: '<a class="company-name inline-link" href="https://www.nationwide.com/" rel="nofollow" target="_blank">Nationwide</a>', premium: '$7,160' },
    { company: '<a class="company-name inline-link" href="https://www.chubb.com/uk-en/" rel="nofollow" target="_blank">Chubb</a>', premium: '$9,730' },
  ];

  zipRateRows = [
    { zipCode: '77581', neighborhood: 'Green Tee', annualCost: '$4,120', highlighted: false },
    { zipCode: '77584', neighborhood: 'Southwyck', annualCost: '$4,350', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('PEARLAND_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('PEARLAND_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('PEARLAND_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('PEARLAND_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('PEARLAND_HOME_TX.NEIGHBORHOODS.ROWS');
  }
