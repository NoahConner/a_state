...
@Component({
  selector: 'app-homeowners-corpus-christi-tx',
  standalone: false,
  templateUrl: './corpus-christi-tx.html',
  styleUrl: './corpus-christi-tx.scss',
})
export class HomeownersCorpusChristiTx implements AfterViewInit {
  ...
  annualRates = [
    { company: '<a class="company-name inline-link" href="https://progressivehome.com/" rel="nofollow" target="_blank">Progressive Home</a>', premium: '$1,018' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', premium: '$1,118' },
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/" rel="nofollow" target="_blank">USAA</a>', premium: '$1,737' },
    { company: '<a class="company-name inline-link" href="https://republicindemnity.com/" rel="nofollow" target="_blank">Republic Indemnity</a>', premium: '$1,993' },
    { company: '<a class="company-name inline-link" href="https://www.afi.org/" rel="nofollow" target="_blank">Armed Forces Insurance Exchange</a>', premium: '$2,639' },
    { company: '<a class="company-name inline-link" href="https://www.travelers.com/" rel="nofollow" target="_blank">Travelers</a>', premium: '$2,953' },
    { company: '<a class="company-name inline-link" href="https://www.texasfairplan.org/" rel="nofollow" target="_blank">Texas Fair Plan Association</a>', premium: '$3,163' },
    { company: '<a class="company-name inline-link" href="https://www.foremost.com/" rel="nofollow" target="_blank">Foremost</a>', premium: '$3,727' },
    { company: '<a class="company-name inline-link" href="https://www.txfb-ins.com/" rel="nofollow" target="_blank">Texas Farm Bureau Group</a>', premium: '$4,057' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', premium: '$4,433' },
  ];

  zipRateRows = [
    { zipCode: '78414', neighborhood: 'Southside', annualCost: '$2,452', highlighted: false },
    { zipCode: '78415', neighborhood: 'Central City', annualCost: '$2,544', highlighted: true },
    { zipCode: '78412', neighborhood: 'Bay Area', annualCost: '$2,434', highlighted: false },
    { zipCode: '78413', neighborhood: 'Oso', annualCost: '$2,694', highlighted: true },
    { zipCode: '78418', neighborhood: 'Flour Bluff', annualCost: '$2,179', highlighted: false },
    { zipCode: '78410', neighborhood: 'Calallen', annualCost: '$2,499', highlighted: true },
    { zipCode: '78411', neighborhood: 'Lamar Park', annualCost: '$2,462', highlighted: false },
    { zipCode: '78404', neighborhood: 'Medical District', annualCost: '$2,457', highlighted: true },
    { zipCode: '78416', neighborhood: 'Molina', annualCost: '$2,549', highlighted: false },
    { zipCode: '78405', neighborhood: 'West End', annualCost: '$2,548', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('CORPUS_CHRISTI_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('CORPUS_CHRISTI_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('CORPUS_CHRISTI_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('CORPUS_CHRISTI_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('CORPUS_CHRISTI_HOME_TX.NEIGHBORHOODS.ROWS');
  }
