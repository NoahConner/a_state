...
@Component({
  selector: 'app-homeowners-dallas-tx',
  standalone: false,
  templateUrl: './dallas-tx.html',
  styleUrl: './dallas-tx.scss',
})
export class HomeownersDallasTx implements AfterViewInit {
  ...
  annualRates = [
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', premium: '$1,979' },
    { company: '<a class="company-name inline-link" href="https://www.republicgroup.com/" rel="nofollow" target="_blank">Republic Indemnity</a>', premium: '$2,236' },
    { company: '<a class="company-name inline-link" href="https://www.afi.org/" rel="nofollow" target="_blank">Armed Forces Insurance Exchange</a>', premium: '$2,622' },
    { company: '<a class="company-name inline-link" href="https://www.txfb-ins.com/" rel="nofollow" target="_blank">Texas Farm Bureau Group</a>', premium: '$2,858' },
    { company: '<a class="company-name inline-link" href="https://www.lighthousepropertyins.com/" rel="nofollow" target="_blank">Lighthouse Property Insurance Corp</a>', premium: '$2,943' },
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/" rel="nofollow" target="_blank">USAA</a>', premium: '$3,503' },
    { company: '<a class="company-name inline-link" href="https://www.travelers.com/" rel="nofollow" target="_blank">Travelers</a>', premium: '$3,763' },
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', premium: '$3,776' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', premium: '$3,799' },
  ];

  zipRateRows = [
    { zipCode: '75217', neighborhood: 'Pleasant Grove', annualCost: '$3,101', highlighted: false },
    { zipCode: '75211', neighborhood: 'Oak Cliff', annualCost: '$3,172', highlighted: true },
    { zipCode: '75228', neighborhood: 'Casa View', annualCost: '$3,445', highlighted: false },
    { zipCode: '75243', neighborhood: 'Lake Highlands', annualCost: '$3,260', highlighted: true },
    { zipCode: '75227', neighborhood: 'Urbandale', annualCost: '$3,160', highlighted: false },
    { zipCode: '75216', neighborhood: 'Oak Cliff', annualCost: '$3,452', highlighted: true },
    { zipCode: '75287', neighborhood: 'Far North Dallas', annualCost: '$3,230', highlighted: false },
    { zipCode: '75220', neighborhood: 'Bachman Lake', annualCost: '$3,317', highlighted: true },
    { zipCode: '75231', neighborhood: 'Vickery Meadow', annualCost: '$3,461', highlighted: false },
    { zipCode: '75206', neighborhood: 'Lower Greenville', annualCost: '$3,340', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('DALLAS_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('DALLAS_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('DALLAS_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('DALLAS_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('DALLAS_HOME_TX.NEIGHBORHOODS.ROWS');
  }
