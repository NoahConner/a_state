...
@Component({
  selector: 'app-homeowners-carrollton-tx',
  standalone: false,
  templateUrl: './carrollton-tx.html',
  styleUrl: './carrollton-tx.scss',
})
export class HomeownersCarrolltonTx implements AfterViewInit {
  ...
  annualRates = [
    { company: '<a class="company-name inline-link" href="https://republicindemnity.com/" rel="nofollow" target="_blank">Republic Indemnity</a>', premium: '$1,620' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', premium: '$2,440' },
    { company: '<a class="company-name inline-link" href="https://www.travelers.co.uk/" rel="nofollow" target="_blank">Travelers</a>', premium: '$2,440' },
    ...
    { company: '<a class="company-name inline-link" href="https://www.foremost.com/insurance/home/" rel="nofollow" target="_blank">Foremost</a>', premium: '$3,500' },
    ...
    { company: '<a class="company-name inline-link" href="https://www.chubb.com/uk-en/" rel="nofollow" target="_blank">Chubb</a>', premium: '$7,450' },
  ];

  zipRateRows = [
    { zipCode: '75006', neighborhood: 'Downtown', annualCost: '$3,450', highlighted: false },
    { zipCode: '75007', neighborhood: 'Hebron', annualCost: '$3,620', highlighted: true },
    { zipCode: '75010', neighborhood: 'Mustang', annualCost: '$3,890', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('CARROLLTON_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('CARROLLTON_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('CARROLLTON_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('CARROLLTON_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('CARROLLTON_HOME_TX.NEIGHBORHOODS.ROWS');
  }
