...
@Component({
  selector: 'app-homeowners-the-woodlands-tx',
  standalone: false,
  templateUrl: './the-woodlands-tx.html',
  styleUrl: './the-woodlands-tx.scss',
})
export class HomeownersTheWoodlandsTx implements AfterViewInit {
  ...
  annualRates = [
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/" rel="nofollow" target="_blank">USAA</a>', premium: '$3,233' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', premium: '$4,063' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', premium: '$4,159' },
    { company: '<a class="company-name inline-link" href="https://www.progressive.com/" rel="nofollow" target="_blank">Progressive</a>', premium: '$4,836' },
    { company: '<a class="company-name inline-link" href="https://www.nationwide.com/" rel="nofollow" target="_blank">Nationwide</a>', premium: '$5,155' },
  ];

  zipRateRows = [
    { zipCode: '77380', neighborhood: "Grogan's Mill", annualCost: '$144', highlighted: false },
    { zipCode: '77381', neighborhood: "Panther Creek", annualCost: '$157', highlighted: true },
    { zipCode: '77382', neighborhood: "Alden Bridge", annualCost: '$151', highlighted: false },
    { zipCode: '77384', neighborhood: "College Park", annualCost: '$155', highlighted: true },
    { zipCode: '77385', neighborhood: "Harper's Preserve", annualCost: '$160', highlighted: false },
    { zipCode: '77386', neighborhood: "Creekside Park", annualCost: '$165', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('THE_WOODLANDS_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('THE_WOODLANDS_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('THE_WOODLANDS_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('THE_WOODLANDS_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('THE_WOODLANDS_HOME_TX.NEIGHBORHOODS.ROWS');
  }
