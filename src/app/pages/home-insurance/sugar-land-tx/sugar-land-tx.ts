...
@Component({
  selector: 'app-homeowners-sugar-land-tx',
  standalone: false,
  templateUrl: './sugar-land-tx.html',
  styleUrl: './sugar-land-tx.scss',
})
export class HomeownersSugarLandTx implements AfterViewInit {
  ...
  annualRates = [
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/" rel="nofollow" target="_blank">USAA</a>', premium: '$2,556' },
    { company: '<a class="company-name inline-link" href="https://www.travelers.com/" rel="nofollow" target="_blank">Travelers</a>', premium: '$2,940' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', premium: '$2,856' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', premium: '$3,000' },
    { company: '<a class="company-name inline-link" href="https://www.amica.com/" rel="nofollow" target="_blank">Amica</a>', premium: '$3,156' },
  ...
  zipRateRows = [
    { zipCode: '77083', neighborhood: "Alief", annualCost: '$150', highlighted: false },
    { zipCode: '77479', neighborhood: "Greatwood", annualCost: '$152', highlighted: true },
    { zipCode: '77459', neighborhood: "Missouri City", annualCost: '$151', highlighted: false },
    { zipCode: '77498', neighborhood: "Town Center", annualCost: '$154', highlighted: true },
    { zipCode: '77478', neighborhood: "First Colony", annualCost: '$144', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('SUGAR_LAND_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('SUGAR_LAND_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('SUGAR_LAND_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('SUGAR_LAND_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('SUGAR_LAND_HOME_TX.NEIGHBORHOODS.ROWS');
  }
