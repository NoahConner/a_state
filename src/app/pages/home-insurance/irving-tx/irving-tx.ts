...
@Component({
  selector: 'app-homeowners-irving-tx',
  standalone: false,
  templateUrl: './irving-tx.html',
  styleUrl: './irving-tx.scss',
})
export class HomeownersIrvingTx implements AfterViewInit {
  ...
  annualRates = [
    { company: '<a class="company-name inline-link" href="https://texasfarmbureau.org/" rel="nofollow" target="_blank">Texas Farmers</a>', premium: '$256' },
    { company: '<a class="company-name inline-link" href="https://www.libertymutual.com/" rel="nofollow" target="_blank">Liberty Mutual</a>', premium: '$2,865' },
    { company: '<a class="company-name inline-link" href="https://www.isbinsurance.net/insurance-companies/asi-lloyds" rel="nofollow" target="_blank">ASI Lloyds</a>', premium: '$2,903' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', premium: '$3,138' },
    { company: '<a class="company-name inline-link" href="https://www.uhc.com/" rel="nofollow" target="_blank">United</a>', premium: '$3,176' },
  ];

  zipRateRows = [
    { zipCode: '75063', neighborhood: 'Valley Ranch', annualCost: '$3,524', highlighted: false },
    { zipCode: '75038', neighborhood: 'Las Colinas', annualCost: '$3,566', highlighted: true },
    { zipCode: '75039', neighborhood: 'Urban Center', annualCost: '$3,570', highlighted: false },
    { zipCode: '75060', neighborhood: 'South Irving', annualCost: '$3,687', highlighted: true },
    { zipCode: '75062', neighborhood: 'Cottonwood', annualCost: '$3,630', highlighted: false },
    { zipCode: '75061', neighborhood: 'Heritage District', annualCost: '$3,598', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('IRVING_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('IRVING_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('IRVING_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('IRVING_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('IRVING_HOME_TX.NEIGHBORHOODS.ROWS');
  }
