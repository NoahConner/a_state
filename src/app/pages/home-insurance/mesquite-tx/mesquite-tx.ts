...
@Component({
  selector: 'app-homeowners-mesquite-tx',
  standalone: false,
  templateUrl: './mesquite-tx.html',
  styleUrl: './mesquite-tx.scss',
})
export class HomeownersMesquiteTx implements AfterViewInit {
  ...
  annualRates = [
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', premium: '$2,490' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', premium: '$3,120' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', premium: '$3,350' },
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/" rel="nofollow" target="_blank">USAA</a>', premium: '$3,540' },
    { company: '<a class="company-name inline-link" href="https://www.chubb.com/uk-en/" rel="nofollow" target="_blank">Chubb</a>', premium: '$7,210' },
  ];

  zipRateRows = [
    { zipCode: '75149', neighborhood: 'South Mesquite', annualCost: '$2,950', highlighted: false },
    { zipCode: '75150', neighborhood: 'North Mesquite', annualCost: '$3,120', highlighted: true },
    { zipCode: '75180', neighborhood: 'Downtown Mesquite', annualCost: '$2,840', highlighted: false },
    { zipCode: '75181', neighborhood: 'East Mesquite', annualCost: '$3,350', highlighted: true },
    { zipCode: '75182', neighborhood: 'West Mesquite', annualCost: '$3,350', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('MESQUITE_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('MESQUITE_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('MESQUITE_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('MESQUITE_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('MESQUITE_HOME_TX.NEIGHBORHOODS.ROWS');
  }
