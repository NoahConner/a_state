...
@Component({
  selector: 'app-homeowners-killeen-tx',
  standalone: false,
  templateUrl: './killeen-tx.html',
  styleUrl: './killeen-tx.scss',
})
export class HomeownersKilleenTx implements AfterViewInit {
  ...
  annualRates = [
    ...
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', premium: '$3,436' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/texas/" rel="nofollow" target="_blank">Farmers</a>', premium: '$3,630' },
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/" rel="nofollow" target="_blank">USAA</a>', premium: '$3,891' },
    { company: '<a class="company-name inline-link" href="https://www.chubb.com/pk-en/" rel="nofollow" target="_blank">Chubb</a>', premium: '$7,966' },
  ];

  zipRateRows = [
    { zipCode: '76541', neighborhood: 'East Killeen', annualCost: '$2,780', highlighted: false },
    { zipCode: '76542', neighborhood: 'South Killeen', annualCost: '$3,150', highlighted: true },
    { zipCode: '76543', neighborhood: 'West Killeen', annualCost: '$3,420', highlighted: false },
    { zipCode: '76549', neighborhood: 'KILLEEN_HOME_TX.RATES.ZIP_NEIGHBORHOOD_HARKER', annualCost: '$3,650', highlighted: true },
    { zipCode: '76540', neighborhood: 'KILLEEN_HOME_TX.RATES.ZIP_NEIGHBORHOOD_CENTRAL', annualCost: '$2,910', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('KILLEEN_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('KILLEEN_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('KILLEEN_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('KILLEEN_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('KILLEEN_HOME_TX.NEIGHBORHOODS.ROWS');
  }
