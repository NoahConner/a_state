...
@Component({
  selector: 'app-homeowners-richardson-tx',
  standalone: false,
  templateUrl: './richardson-tx.html',
  styleUrl: './richardson-tx.scss',
})
export class HomeownersRichardsonTx implements AfterViewInit {
  ...
  annualRates = [
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/" rel="nofollow" target="_blank">USAA</a>', premium: '$2,064' },
    { company: '<a class="company-name inline-link" href="https://www.travelers.com/" rel="nofollow" target="_blank">Travelers</a>', premium: '$2,376' },
    ...
    { company: '<a class="company-name inline-link" href="https://www.amica.com/" rel="nofollow" target="_blank">Amica</a>', premium: '$2,544' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', premium: '$2,664' },
  ];

  zipRateRows = [
    { zipCode: '75080', neighborhood: "Canyon Creek", annualCost: '$2,250', highlighted: false },
    { zipCode: '75081', neighborhood: "Heights Park", annualCost: '$2,180', highlighted: true },
    { zipCode: '75082', neighborhood: "Breckinridge Park", annualCost: '$2,420', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('RICHARDSON_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('RICHARDSON_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('RICHARDSON_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('RICHARDSON_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('RICHARDSON_HOME_TX.NEIGHBORHOODS.ROWS');
  }
