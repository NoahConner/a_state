...
@Component({
  selector: 'app-homeowners-amarillo-tx',
  standalone: false,
  templateUrl: './amarillo-tx.html',
  styleUrl: './amarillo-tx.scss',
})
export class HomeownersAmarilloTx implements AfterViewInit {
  ...
  annualRates = [
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', premium: '$4,452' },
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/" rel="nofollow" target="_blank">USAA</a>', premium: '$4,776' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', premium: '$5,664' },
    { company: '<a class="company-name inline-link" href="https://www.chubb.com/us-en/" rel="nofollow" target="_blank">Chubb</a>', premium: '$15,684' },
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', premium: '$2,760' },
  ];

  zipRateRows = [
    { zipCode: '79124', neighborhood: 'Northwest Amarillo', annualCost: '$3,789', highlighted: false },
    { zipCode: '79101', neighborhood: 'Downtown Amarillo', annualCost: '$3,945', highlighted: true },
    { zipCode: '79159', neighborhood: 'Central Amarillo', annualCost: '$4,054', highlighted: false },
    { zipCode: '79107', neighborhood: 'North Amarillo', annualCost: '$4,100', highlighted: true },
    { zipCode: '79114', neighborhood: 'Tascosa', annualCost: '$4,315', highlighted: false },
    { zipCode: '79119', neighborhood: 'Southwest Amarillo', annualCost: '$5,110', highlighted: true },
    { zipCode: '79109', neighborhood: 'South Amarillo', annualCost: '$5,201', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('AMARILLO_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('AMARILLO_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('AMARILLO_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('AMARILLO_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('AMARILLO_HOME_TX.NEIGHBORHOODS.ROWS');
  }
