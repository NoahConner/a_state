...
@Component({
  selector: 'app-homeowners-edinburg-tx',
  standalone: false,
  templateUrl: './edinburg-tx.html',
  styleUrl: './edinburg-tx.scss',
})
export class HomeownersEdinburgTx implements AfterViewInit {
  ...
  annualRates = [
    { company: '<a class="company-name inline-link" href="https://www.travelers.com/" rel="nofollow" target="_blank">Travelers</a>', premium: '$1,030' },
    { company: '<a class="company-name inline-link" href="https://www.upcinsurance.com/" rel="nofollow" target="_blank">United Property &amp; Casualty</a>', premium: '$1,136' },
    { company: '<a class="company-name inline-link" href="https://www.homesite.com/" rel="nofollow" target="_blank">Homesite</a>', premium: '$1,187' },
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', premium: '$1,282' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', premium: '$1,412' },
  ];

  zipRateRows = [
    { zipCode: '78539', neighborhood: "EDINBURG_HOME_TX.ZIP_NEIGHBORHOODS.Z78539", annualCost: '$1,864', highlighted: false },
    { zipCode: '78542', neighborhood: "EDINBURG_HOME_TX.ZIP_NEIGHBORHOODS.Z78542", annualCost: '$1,733', highlighted: true },
    { zipCode: '78540', neighborhood: "EDINBURG_HOME_TX.ZIP_NEIGHBORHOODS.Z78540", annualCost: 'EDINBURG_HOME_TX.ZIP_VARIES', highlighted: false },
    { zipCode: '78541', neighborhood: "EDINBURG_HOME_TX.ZIP_NEIGHBORHOODS.Z78541", annualCost: 'EDINBURG_HOME_TX.ZIP_VARIES', highlighted: true },
    { zipCode: '78538', neighborhood: "EDINBURG_HOME_TX.ZIP_NEIGHBORHOODS.Z78538", annualCost: 'EDINBURG_HOME_TX.ZIP_VARIES', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('EDINBURG_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('EDINBURG_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('EDINBURG_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('EDINBURG_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('EDINBURG_HOME_TX.NEIGHBORHOODS.ROWS');
  }
