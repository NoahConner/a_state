...
@Component({
  selector: 'app-homeowners-lubbock-tx',
  standalone: false,
  templateUrl: './lubbock-tx.html',
  styleUrl: './lubbock-tx.scss',
})
export class HomeownersLubbockTx implements AfterViewInit {
  ...
  annualRates = [
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', premium: '$3,950' },
    { company: '<a class="company-name inline-link" href="https://www.guard.com/amguard-insurance-company/" rel="nofollow" target="_blank">AmGUARD Insurance Company</a>', premium: '$3,710' },
    { company: '<a class="company-name inline-link" href="https://www.afi.org/" rel="nofollow" target="_blank">Armed Forces Insurance Exchange</a>', premium: '$1,664' },
    { company: '<a class="company-name inline-link" href="https://www.asi-assurance.org/" rel="nofollow" target="_blank">ASI</a>', premium: '$554' },
    { company: '<a class="company-name inline-link" href="https://bankersinsurance.com/" rel="nofollow" target="_blank">Bankers Insurance Group</a>', premium: '$2,727' },
    { company: '<a class="company-name inline-link" href="https://www.chubb.com/us-en/" rel="nofollow" target="_blank">Chubb</a>', premium: '$9,667' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', premium: '$499' },
    { company: '<a class="company-name inline-link" href="https://www.foremost.com/" rel="nofollow" target="_blank">Foremost</a>', premium: '$1,761' },
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', premium: '$1,171' },
    { company: '<a class="company-name inline-link" href="https://www.nationwide.com/" rel="nofollow" target="_blank">Nationwide</a>', premium: '$2,755' },
    { company: '<a class="company-name inline-link" href="https://republicindemnity.com/" rel="nofollow" target="_blank">Republic Indemnity</a>', premium: '$942' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', premium: '$1,024' },
    { company: '<a class="company-name inline-link" href="https://www.texasfairplan.org/" rel="nofollow" target="_blank">Texas Fair Plan Association</a>', premium: '$1,495' },
    { company: '<a class="company-name inline-link" href="https://www.txfb-ins.com/" rel="nofollow" target="_blank">Texas Farm Bureau Group</a>', premium: '$2,587' },
    { company: '<a class="company-name inline-link" href="https://www.travelers.com/" rel="nofollow" target="_blank">Travelers</a>', premium: '$1,395' },
    { company: '<a class="company-name inline-link" href="https://www.uihna.com/en-US/" rel="nofollow" target="_blank">Universal Insurance Company of North America</a>', premium: '$6,854' },
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/" rel="nofollow" target="_blank">USAA</a>', premium: '$2,515' },
  ];

  zipRateRows = [
    { zipCode: '79409', neighborhood: 'Texas Tech University', annualCost: '$3,301', highlighted: false },
    { zipCode: '79402', neighborhood: 'Overton', annualCost: '$3,302', highlighted: true },
    { zipCode: '79407', neighborhood: 'West End', annualCost: '$3,324', highlighted: false },
    { zipCode: '79430', neighborhood: 'Health Sciences Center', annualCost: '$4,148', highlighted: true },
    { zipCode: '79406', neighborhood: 'Tech Terrace', annualCost: '$3,382', highlighted: false },
    { zipCode: '79403', neighborhood: 'North Lubbock', annualCost: '$3,377', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('LUBBOCK_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('LUBBOCK_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('LUBBOCK_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('LUBBOCK_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('LUBBOCK_HOME_TX.NEIGHBORHOODS.ROWS');
  }
