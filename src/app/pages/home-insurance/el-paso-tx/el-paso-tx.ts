...
@Component({
  selector: 'app-homeowners-el-paso-tx',
  standalone: false,
  templateUrl: './el-paso-tx.html',
  styleUrl: './el-paso-tx.scss',
})
export class HomeownersElPasoTx implements AfterViewInit {
  ...
  annualRates = [
    { company: '<a class="company-name inline-link" href="https://republicindemnity.com/" rel="nofollow" target="_blank">Republic Indemnity</a>', premium: '$768' },
    { company: '<a class="company-name inline-link" href="https://www.travelers.com/" rel="nofollow" target="_blank">Travelers</a>', premium: '$996' },
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', premium: '$1,116' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', premium: '$1,416' },
    { company: '<a class="company-name inline-link" href="https://www.foremost.com/" rel="nofollow" target="_blank">Foremost</a>', premium: '$1,452' },
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/" rel="nofollow" target="_blank">USAA</a>', premium: '$1,644' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', premium: '$1,716' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', premium: '$1,812' },
    { company: '<a class="company-name inline-link" href="https://www.nationwide.com/" rel="nofollow" target="_blank">Nationwide</a>', premium: '$2,292' },
    { company: '<a class="company-name inline-link" href="https://www.chubb.com/us-en/" rel="nofollow" target="_blank">Chubb</a>', premium: '$3,324' },
  ];

  zipRateRows = [
    { zipCode: '79906', neighborhood: 'Fort Bliss', annualCost: '$1,752', highlighted: false },
    { zipCode: '79910', neighborhood: 'Downtown', annualCost: '$1,762', highlighted: true },
    { zipCode: '79968', neighborhood: 'UTEP', annualCost: '$1,762', highlighted: false },
    { zipCode: '79927', neighborhood: 'Socorro', annualCost: '$1,889', highlighted: true },
    { zipCode: '79907', neighborhood: 'Ysleta', annualCost: '$1,877', highlighted: false },
    { zipCode: '79905', neighborhood: 'Chamizal', annualCost: '$1,870', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('EL_PASO_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('EL_PASO_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('EL_PASO_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('EL_PASO_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('EL_PASO_HOME_TX.NEIGHBORHOODS.ROWS');
  }
