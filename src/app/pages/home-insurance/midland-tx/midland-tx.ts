...
@Component({
  selector: 'app-homeowners-midland-tx',
  standalone: false,
  templateUrl: './midland-tx.html',
  styleUrl: './midland-tx.scss',
})
export class HomeownersMidlandTx implements AfterViewInit {
  ...
  annualRates = [
    { company: '<a class="company-name inline-link" href="https://www.republicindemnity.com/" rel="nofollow" target="_blank">Republic Indemnity</a>', premium: '$1,850' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', premium: '$2,790' },
    { company: '<a class="company-name inline-link" href="https://www.travelers.com/" rel="nofollow" target="_blank">Travelers</a>', premium: '$2,790' },
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', premium: '$3,360' },
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/" rel="nofollow" target="_blank">USAA</a>', premium: '$3,640' },
    { company: '<a class="company-name inline-link" href="https://www.foremost.com/" rel="nofollow" target="_blank">Foremost</a>', premium: '$4,000' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', premium: '$4,200' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', premium: '$4,250' },
    { company: '<a class="company-name inline-link" href="https://www.nationwide.com/" rel="nofollow" target="_blank">Nationwide</a>', premium: '$6,260' },
    { company: '<a class="company-name inline-link" href="https://www.chubb.com/pk-en/" rel="nofollow" target="_blank">Chubb</a>', premium: '$8,520' },
  ];

  zipRateRows = [
    { zipCode: '79701', neighborhood: 'Downtown', annualCost: '$3,250', highlighted: false },
    { zipCode: '79703', neighborhood: 'Midland', annualCost: '$3,080', highlighted: true },
    { zipCode: '79705', neighborhood: 'Northgate', annualCost: '$3,620', highlighted: false },
    { zipCode: '79707', neighborhood: 'Green Tree', annualCost: '$3,950', highlighted: true },
    { zipCode: '79706', neighborhood: 'Southland', annualCost: '$3,150', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('MIDLAND_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('MIDLAND_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('MIDLAND_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('MIDLAND_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('MIDLAND_HOME_TX.NEIGHBORHOODS.ROWS');
  }
