...
@Component({
  selector: 'app-homeowners-abilene-tx',
  standalone: false,
  templateUrl: './abilene-tx.html',
  styleUrl: './abilene-tx.scss',
})
export class HomeownersAbileneTx implements AfterViewInit {
  ...
  zipRateRows = [
    { zipCode: '79601', neighborhood: 'Downtown', annualCost: '$3,500', highlighted: false },
    { zipCode: '79602', neighborhood: 'Elmwood', annualCost: '$3,450', highlighted: true },
    { zipCode: '79603', neighborhood: 'North Park', annualCost: '$3,300', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('ABILENE_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('ABILENE_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('ABILENE_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('ABILENE_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('ABILENE_HOME_TX.NEIGHBORHOODS.ROWS');
  }
