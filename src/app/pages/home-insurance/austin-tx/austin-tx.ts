...
@Component({
  selector: 'app-homeowners-austin-tx',
  standalone: false,
  templateUrl: './austin-tx.html',
  styleUrl: './austin-tx.scss',
})
export class HomeownersAustinTx implements AfterViewInit {
  ...
  annualRates = [
    { company: '<a class="company-name inline-link" href="https://www.republicgroup.com/" rel="nofollow" target="_blank">Republic Indemnity</a>', premium: '$972' },
    { company: '<a class="company-name inline-link" href="https://www.travelers.com/" rel="nofollow" target="_blank">Travelers</a>', premium: '$1,320' },
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', premium: '$1,680' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', premium: '$1,812' },
    { company: '<a class="company-name inline-link" href="https://www.foremost.com/" rel="nofollow" target="_blank">Foremost</a>', premium: '$1,956' },
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/" rel="nofollow" target="_blank">USAA</a>', premium: '$2,016' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', premium: '$2,424' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', premium: '$2,640' },
    { company: '<a class="company-name inline-link" href="https://www.nationwide.com/" rel="nofollow" target="_blank">Nationwide</a>', premium: '$2,880' },
    { company: '<a class="company-name inline-link" href="https://www.chubb.com/" rel="nofollow" target="_blank">Chubb</a>', premium: '$4,116' },
  ];

  zipRateRows = [
    { zipCode: '78745', neighborhood: 'South Lamar', annualCost: '$2,179', highlighted: false },
    { zipCode: '78753', neighborhood: 'North Lamar', annualCost: '$2,258', highlighted: true },
    { zipCode: '78748', neighborhood: 'Manchaca', annualCost: '$2,064', highlighted: false },
    { zipCode: '78758', neighborhood: 'North Park Estates', annualCost: '$2,138', highlighted: true },
    { zipCode: '78704', neighborhood: 'South Congress', annualCost: '$2,154', highlighted: false },
    { zipCode: '78744', neighborhood: 'Dove Springs', annualCost: '$2,206', highlighted: true },
    { zipCode: '78741', neighborhood: 'Riverside', annualCost: '$2,255', highlighted: false },
    { zipCode: '78759', neighborhood: 'Great Hills', annualCost: '$2,092', highlighted: true },
    { zipCode: '78723', neighborhood: 'Mueller', annualCost: '$2,239', highlighted: false },
    { zipCode: '78749', neighborhood: 'Circle C Ranch', annualCost: '$2,051', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('AUSTIN_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('AUSTIN_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('AUSTIN_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('AUSTIN_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('AUSTIN_HOME_TX.NEIGHBORHOODS.ROWS');
  }
