...
@Component({
  selector: 'app-homeowners-mcallen-tx',
  standalone: false,
  templateUrl: './mcallen-tx.html',
  styleUrl: './mcallen-tx.scss',
})
export class HomeownersMcallenTx implements AfterViewInit {
  ...
  annualRates = [
    { company: '<a class="company-name inline-link" href="https://www.asi-assurance.org/" rel="nofollow" target="_blank">ASI</a>', premium: '$871' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', premium: '$931' },
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/" rel="nofollow" target="_blank">USAA</a>', premium: '$1,452' },
    { company: '<a class="company-name inline-link" href="https://www.republicindemnity.com/" rel="nofollow" target="_blank">Republic Indemnity</a>', premium: '$1,668' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', premium: '$1,749' },
    { company: '<a class="company-name inline-link" href="http://travelers" rel="nofollow" target="_blank">Travelers</a>', premium: '$2,471' },
    { company: '<a class="company-name inline-link" href="https://www.afi.org/" rel="nofollow" target="_blank">Armed Forces Insurance Exchange</a>', premium: '$2,640' },
    { company: '<a class="company-name inline-link" href="https://www.texasfairplan.org/" rel="nofollow" target="_blank">Texas Fair Plan Association</a>', premium: '$2,647' },
    { company: '<a class="company-name inline-link" href="https://www.foremost.com/insurance/home/" rel="nofollow" target="_blank">Foremost</a>', premium: '$3,118' },
    { company: '<a class="company-name inline-link" href="https://www.txfb-ins.com/" rel="nofollow" target="_blank">Texas Farm Bureau Group</a>', premium: '$3,395' },
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', premium: '$4,152' },
    { company: '<a class="company-name inline-link" href="https://www.nationwide.com/" rel="nofollow" target="_blank">Nationwide</a>', premium: '$4,503' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', premium: '$5,073' },
    { company: '<a class="company-name inline-link" href="https://www.occidental-ins.com/" rel="nofollow" target="_blank">Occidental/Acceptance Group</a>', premium: '$5,196' },
    { company: '<a class="company-name inline-link" href="https://www.guard.com/amguard-insurance-company/" rel="nofollow" target="_blank">Amguard</a>', premium: '$6,571' },
    { company: '<a class="company-name inline-link" href="https://bankersinsurance.com/" rel="nofollow" target="_blank">Bankers Insurance Group</a>', premium: '$6,655' },
    { company: '<a class="company-name inline-link" href="https://www.onealliancena.com/en-US/" rel="nofollow" target="_blank">Universal Insurance Company of North America</a>', premium: '$12,139' },
    { company: '<a class="company-name inline-link" href="https://www.chubb.com/us-en/individuals-families.html" rel="nofollow" target="_blank">Chubb</a>', premium: '$17,121' },
  ];

  zipRateRows = [
    { zipCode: '78501', neighborhood: 'Central McAllen', annualCost: '$3,450', highlighted: false },
    { zipCode: '78502', neighborhood: 'South McAllen', annualCost: '$3,210', highlighted: true },
    { zipCode: '78503', neighborhood: 'Expressway', annualCost: '$3,680', highlighted: false },
    { zipCode: '78504', neighborhood: 'North McAllen', annualCost: '$3,920', highlighted: true },
    { zipCode: '78505', neighborhood: 'McAllen Heights', annualCost: '$3,150', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('MCALLEN_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('MCALLEN_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('MCALLEN_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('MCALLEN_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('MCALLEN_HOME_TX.NEIGHBORHOODS.ROWS');
  }
