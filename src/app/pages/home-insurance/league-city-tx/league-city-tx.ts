...
@Component({
  selector: 'app-homeowners-league-city-tx',
  standalone: false,
  templateUrl: './league-city-tx.html',
  styleUrl: './league-city-tx.scss',
})
export class HomeownersLeagueCityTx implements AfterViewInit {
  ...
  annualRates = [
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/" rel="nofollow" target="_blank">USAA</a>', premium: '$2,208' },
    { company: '<a class="company-name inline-link" href="https://www.travelers.com/" rel="nofollow" target="_blank">Travelers</a>', premium: '$2,556' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', premium: '$2,604' },
    { company: '<a class="company-name inline-link" href="https://www.nationwide.com/" rel="nofollow" target="_blank">Nationwide</a>', premium: '$2,604' },
    { company: '<a class="company-name inline-link" href="https://www.amica.com/" rel="nofollow" target="_blank">Amica</a>', premium: '$2,736' },
  ];

  zipRateRows = [
    { zipCode: '77573', neighborhood: "League City", annualCost: '$1,796', highlighted: false },
    { zipCode: '77539', neighborhood: "Dickinson", annualCost: '$2,036', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('LEAGUE_CITY_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('LEAGUE_CITY_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('LEAGUE_CITY_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('LEAGUE_CITY_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('LEAGUE_CITY_HOME_TX.NEIGHBORHOODS.ROWS');
  }
