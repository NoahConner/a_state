...
@Component({
  selector: 'app-homeowners-beaumont-tx',
  standalone: false,
  templateUrl: './beaumont-tx.html',
  styleUrl: './beaumont-tx.scss',
})
export class HomeownersBeaumontTx implements AfterViewInit {
  ...
  annualRates = [
    { company: '<a class="company-name inline-link" href="https://republicindemnity.com/" rel="nofollow" target="_blank">Republic Indemnity</a>', premium: '$2,124' },
    { company: '<a class="company-name inline-link" href="https://www.travelers.com/" rel="nofollow" target="_blank">Travelers</a>', premium: '$1,679' },
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', premium: '$2,050' },
    { company: '<a class="company-name inline-link" href="https://www.foremost.com/insurance/home/" rel="nofollow" target="_blank">Foremost</a>', premium: '$3,069' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', premium: '$3,140' },
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/?akredirect=true" rel="nofollow" target="_blank">USAA</a>', premium: '$3,270' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', premium: '$4,217' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', premium: '$4,000' },
    { company: '<a class="company-name inline-link" href="https://www.nationwide.com/" rel="nofollow" target="_blank">Nationwide</a>', premium: '$3,690' },
    { company: '<a class="company-name inline-link" href="https://www.chubb.com/" rel="nofollow" target="_blank">Chubb</a>', premium: '$4,690' },
  ];

  zipRateRows = [
    { zipCode: '77701', neighborhood: "Downtown Beaumont", annualCost: '$2,150', highlighted: false },
    { zipCode: '77702', neighborhood: "Old Town", annualCost: '$2,420', highlighted: true },
    { zipCode: '77703', neighborhood: "North End", annualCost: '$2,180', highlighted: false },
    { zipCode: '77705', neighborhood: "South Beaumont", annualCost: '$2,190', highlighted: true },
    { zipCode: '77706', neighborhood: "West End", annualCost: '$2,650', highlighted: false },
    { zipCode: '77707', neighborhood: "Amelia", annualCost: '$2,480', highlighted: true },
    { zipCode: '77708', neighborhood: "Pine Island", annualCost: '$2,390', highlighted: false },
    { zipCode: '77713', neighborhood: "Bevil Oaks", annualCost: '$2,520', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('BEAUMONT_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('BEAUMONT_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('BEAUMONT_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('BEAUMONT_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('BEAUMONT_HOME_TX.NEIGHBORHOODS.ROWS');
  }
