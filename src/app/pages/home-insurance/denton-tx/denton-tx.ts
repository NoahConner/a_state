...
@Component({
  selector: 'app-homeowners-denton-tx',
  standalone: false,
  templateUrl: './denton-tx.html',
  styleUrl: './denton-tx.scss',
})
export class HomeownersDentonTx implements AfterViewInit {
  ...
  annualRates = [
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', premium: '$2,580' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', premium: '$3,210' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', premium: '$3,450' },
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/" rel="nofollow" target="_blank">USAA</a>', premium: '$3,640' },
    { company: '<a class="company-name inline-link" href="https://www.chubb.com/us-en/" rel="nofollow" target="_blank">Chubb</a>', premium: '$7,450' },
  ];

  zipRateRows = [
    { zipCode: '76201', neighborhood: 'Downtown Denton', annualCost: '$3,150', highlighted: false },
    { zipCode: '76205', neighborhood: 'South Denton', annualCost: '$3,280', highlighted: true },
    { zipCode: '76207', neighborhood: 'East Denton', annualCost: '$3,120', highlighted: false },
    { zipCode: '76208', neighborhood: 'Southeast Denton', annualCost: '$3,450', highlighted: true },
    { zipCode: '76210', neighborhood: 'Southwest Denton', annualCost: '$3,590', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('DENTON_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('DENTON_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('DENTON_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('DENTON_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('DENTON_HOME_TX.NEIGHBORHOODS.ROWS');
  }
