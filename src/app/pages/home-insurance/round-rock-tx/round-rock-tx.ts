...
@Component({
  selector: 'app-homeowners-round-rock-tx',
  standalone: false,
  templateUrl: './round-rock-tx.html',
  styleUrl: './round-rock-tx.scss',
})
export class HomeownersRoundRockTx implements AfterViewInit {
  ...
  annualRates = [
    ...
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', premium: '$2,780' },
    { company: '<a class="company-name inline-link" href="https://www.travelers.com/" rel="nofollow" target="_blank">Travelers</a>', premium: '$2,780' },
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', premium: '$3,350' },
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/" rel="nofollow" target="_blank">USAA</a>', premium: '$3,620' },
    { company: '<a class="company-name inline-link" href="https://www.foremost.com/" rel="nofollow" target="_blank">Foremost</a>', premium: '$3,990' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', premium: '$4,190' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', premium: '$4,240' },
    { company: '<a class="company-name inline-link" href="https://www.nationwide.com/" rel="nofollow" target="_blank">Nationwide</a>', premium: '$6,250' },
    { company: '<a class="company-name inline-link" href="https://www.chubb.com/pk-en/" rel="nofollow" target="_blank">Chubb</a>', premium: '$8,490' },
  ];

  zipRateRows = [
    { zipCode: '78664', neighborhood: 'Greenslopes', annualCost: '$3,650', highlighted: false },
    { zipCode: '78665', neighborhood: 'Forest Creek', annualCost: '$3,920', highlighted: true },
    { zipCode: '78681', neighborhood: 'Lake Creek', annualCost: '$3,510', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('ROUND_ROCK_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('ROUND_ROCK_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('ROUND_ROCK_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('ROUND_ROCK_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('ROUND_ROCK_HOME_TX.NEIGHBORHOODS.ROWS');
  }
