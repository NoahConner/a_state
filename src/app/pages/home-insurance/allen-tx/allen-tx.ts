...
@Component({
  selector: 'app-homeowners-allen-tx',
  standalone: false,
  templateUrl: './allen-tx.html',
  styleUrl: './allen-tx.scss',
})
export class HomeownersAllenTx implements AfterViewInit {
  ...
  annualRates = [
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', premium: '$2,232' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', premium: '$2,304' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/texas/" rel="nofollow" target="_blank">Farmers</a>', premium: '$2,592' },
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/?akredirect=true" rel="nofollow" target="_blank">USAA</a>', premium: '$2,004' },
    { company: '<a class="company-name inline-link" href="https://www.chubb.com/pk-en/" rel="nofollow" target="_blank">Chubb</a>', premium: '$3,180' },
  ];

  zipRateRows = [
    { zipCode: '75002', neighborhood: "Central Allen", annualCost: '$1,835', highlighted: false },
    { zipCode: '75013', neighborhood: "North Allen", annualCost: '$1,774', highlighted: true },
    { zipCode: '75002', neighborhood: "Bethany Ridge Estates", annualCost: '$1,835', highlighted: false },
    { zipCode: '75013', neighborhood: "Twin Creeks", annualCost: '$1,774', highlighted: true },
    { zipCode: '75013', neighborhood: "Watters Crossing", annualCost: '$1,774', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('ALLEN_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('ALLEN_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('ALLEN_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('ALLEN_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('ALLEN_HOME_TX.NEIGHBORHOODS.ROWS');
  }
