...
@Component({
  selector: 'app-homeowners-tyler-tx',
  standalone: false,
  templateUrl: './tyler-tx.html',
  styleUrl: './tyler-tx.scss',
})
export class HomeownersTylerTx implements AfterViewInit {
  ...
  annualRates = [
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/" rel="nofollow" target="_blank">USAA</a>', premium: '$105' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', premium: '$118' },
    { company: '<a class="company-name inline-link" href="https://www.nationwide.com/" rel="nofollow" target="_blank">Nationwide</a>', premium: '$124' },
    { company: '<a class="company-name inline-link" href="https://www.amica.com/" rel="nofollow" target="_blank">Amica</a>', premium: '$130' },
    { company: '<a class="company-name inline-link" href="https://www.chubb.com/" rel="nofollow" target="_blank">Chubb</a>', premium: '$167' },
  ];

  zipRateRows = [
    { zipCode: '75701', neighborhood: "Central Tyler", annualCost: '$2,322', highlighted: false },
    { zipCode: '75702', neighborhood: "North Tyler", annualCost: '$2,150', highlighted: true },
    { zipCode: '75703', neighborhood: "South Tyler", annualCost: '$2,280', highlighted: false },
    { zipCode: '75704', neighborhood: "West Tyler", annualCost: '$1,985', highlighted: true },
    { zipCode: '75706', neighborhood: "North Tyler Area", annualCost: '$1,949', highlighted: false },
    { zipCode: '75708', neighborhood: "Northeast Tyler", annualCost: '$2,090', highlighted: true },
    { zipCode: '75709', neighborhood: "Southwest Tyler", annualCost: '$2,436', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('TYLER_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('TYLER_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('TYLER_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('TYLER_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('TYLER_HOME_TX.NEIGHBORHOODS.ROWS');
  }
