...
@Component({
  selector: 'app-homeowners-odessa-tx',
  standalone: false,
  templateUrl: './odessa-tx.html',
  styleUrl: './odessa-tx.scss',
})
export class HomeownersOdessaTx implements AfterViewInit {
  ...
  annualRates = [
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', premium: '$586' },
    { company: '<a class="company-name inline-link" href="https://www.stateauto.com/" rel="nofollow" target="_blank">State Auto</a>', premium: '$628' },
    { company: '<a class="company-name inline-link" href="https://www.txfb-ins.com/" rel="nofollow" target="_blank">Texas Farm Bureau Group</a>', premium: '$691' },
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/?akredirect=true" rel="nofollow" target="_blank">USAA</a>', premium: '$2,339' },
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', premium: '$2,483' },
    { company: '<a class="company-name inline-link" href="https://www.chubb.com/us-en/individuals-families.html" rel="nofollow" target="_blank">Chubb</a>', premium: '$2,708' },
    { company: '<a class="company-name inline-link" href="https://www.iatinsurance.com/" rel="nofollow" target="_blank">IAT Insurance Group</a>', premium: '$2,884' },
    { company: '<a class="company-name inline-link" href="https://www.upcinsurance.com/" rel="nofollow" target="_blank">UPC Insurance</a>', premium: '$4,012' },
    { company: '<a class="company-name inline-link" href="https://www.nationwide.com/" rel="nofollow" target="_blank">Nationwide</a>', premium: '$4,127' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', premium: '$4,458' },
    { company: '<a class="company-name inline-link" href="https://www.texasfairplan.org/" rel="nofollow" target="_blank">Texas Fair Plan Association</a>', premium: '$5,403' },
    { company: '<a class="company-name inline-link" href="https://www.progressive.com/" rel="nofollow" target="_blank">Progressive</a>', premium: '$5,488' },
    { company: '<a class="company-name inline-link" href="https://www.guard.com/" rel="nofollow" target="_blank">AmGUARD</a>', premium: '$6,771' },
    { company: '<a class="company-name inline-link" href="https://www.amica.com/" rel="nofollow" target="_blank">Amica</a>', premium: '$6,836' },
  ];

  zipRateRows = [
    { zipCode: '79762', neighborhood: "North Odessa", annualCost: '$3,434', highlighted: false },
    { zipCode: '79763', neighborhood: "West Odessa", annualCost: '$3,349', highlighted: true },
    { zipCode: '79761', neighborhood: "Central Odessa", annualCost: '$3,434', highlighted: false },
    { zipCode: '79764', neighborhood: "East Odessa", annualCost: '$3,341', highlighted: true },
    { zipCode: '79765', neighborhood: "Southwest Odessa", annualCost: '$3,340', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('ODESSA_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('ODESSA_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('ODESSA_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('ODESSA_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('ODESSA_HOME_TX.NEIGHBORHOODS.ROWS');
  }
