...
@Component({
  selector: 'app-homeowners-plano-tx',
  standalone: false,
  templateUrl: './plano-tx.html',
  styleUrl: './plano-tx.scss',
})
export class HomeownersPlanoTx implements AfterViewInit {
  ...
  annualRates = [
    { company: '<a class="company-name inline-link" href="https://www.txfb-ins.com/" rel="nofollow" target="_blank">Texas Farmers</a>', premium: '$302' },
    { company: '<a class="company-name inline-link" href="https://www.libertymutual.com/" rel="nofollow" target="_blank">Liberty Mutual</a>', premium: '$2,683' },
    { company: '<a class="company-name inline-link" href="https://www.travelers.com/" rel="nofollow" target="_blank">Travelers</a>', premium: '$2,726' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', premium: '$3,037' },
    { company: '<a class="company-name inline-link" href="https://www.americanstrategic.com/" rel="nofollow" target="_blank">ASI Lloyds</a>', premium: '$3,250' },
  ];

  zipRateRows = [
    { zipCode: '75025', neighborhood: 'Russell Creek', annualCost: '$3,164', highlighted: false },
    { zipCode: '75024', neighborhood: 'Legacy Park', annualCost: '$3,177', highlighted: true },
    { zipCode: '75074', neighborhood: 'Old Town Plano', annualCost: '$3,218', highlighted: false },
    { zipCode: '75075', neighborhood: 'Pitman Creek', annualCost: '$3,268', highlighted: true },
    { zipCode: '75023', neighborhood: 'Central Plano', annualCost: '$3,249', highlighted: false },
    { zipCode: '75093', neighborhood: 'Willow Bend', annualCost: '$3,238', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('PLANO_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('PLANO_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('PLANO_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('PLANO_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('PLANO_HOME_TX.NEIGHBORHOODS.ROWS');
  }
