...
@Component({
  selector: 'app-homeowners-laredo-tx',
  standalone: false,
  templateUrl: './laredo-tx.html',
  styleUrl: './laredo-tx.scss',
})
export class HomeownersLaredoTx implements AfterViewInit {
  ...
  annualRates = [
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/texas/" rel="nofollow" target="_blank">Texas Farmers</a>', premium: '$170' },
    { company: '<a class="company-name inline-link" href="https://www.uuinsurance.com/" rel="nofollow" target="_blank">United</a>', premium: '$955' },
    { company: '<a class="company-name inline-link" href="https://www.altasurance.com/american-strategic-insurance/" rel="nofollow" target="_blank">ASI Lloyds</a>', premium: '$1,316' },
    { company: '<a class="company-name inline-link" href="https://www.libertymutual.com/" rel="nofollow" target="_blank">Liberty Mutual</a>', premium: '$1,594' },
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/" rel="nofollow" target="_blank">USAA</a>', premium: '$2,175' },
  ];

  zipRateRows = [
    { zipCode: '78045', neighborhood: 'North Laredo', annualCost: '$2,013', highlighted: false },
    { zipCode: '78040', neighborhood: 'LAREDO_HOME_TX.RATES.ZIP_NEIGHBORHOOD_DOWNTOWN', annualCost: '$2,018', highlighted: true },
    { zipCode: '78041', neighborhood: 'Heights', annualCost: '$2,024', highlighted: false },
    { zipCode: '78049', neighborhood: 'Mines Road', annualCost: '$2,908', highlighted: true },
    { zipCode: '78043', neighborhood: 'South Laredo', annualCost: '$2,029', highlighted: false },
    { zipCode: '78046', neighborhood: 'Cielito Lindo', annualCost: '$2,026', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('LAREDO_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('LAREDO_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('LAREDO_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('LAREDO_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('LAREDO_HOME_TX.NEIGHBORHOODS.ROWS');
  }
