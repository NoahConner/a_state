...
@Component({
  selector: 'app-homeowners-wichita-falls-tx',
  standalone: false,
  templateUrl: './wichita-falls-tx.html',
  styleUrl: './wichita-falls-tx.scss',
})
export class HomeownersWichitaFallsTx implements AfterViewInit {
  ...
  annualRates = [
    { company: '<a class="company-name inline-link" href="https://www.nationwide.com/" rel="nofollow" target="_blank">Nationwide</a>', premium: '$1,630' },
    { company: '<a class="company-name inline-link" href="https://www.alliedinsurance.com/" rel="nofollow" target="_blank">Allied Property and Casualty</a>', premium: '$1,720' },
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">American Mercury</a>', premium: '$1,861' },
    { company: '<a class="company-name inline-link" href="https://www.homesite.com/" rel="nofollow" target="_blank">Homesite</a>', premium: '$2,077' },
    { company: '<a class="company-name inline-link" href="https://upcinsurance.com/" rel="nofollow" target="_blank">United Property &amp; Casualty</a>', premium: '$2,314' },
    { company: '<a class="company-name inline-link" href="https://www.amica.com/" rel="nofollow" target="_blank">Amica</a>', premium: '$2,422' },
    { company: '<a class="company-name inline-link" href="https://www.republiclloyds.com/" rel="nofollow" target="_blank">Republic Lloyds</a>', premium: '$2,474' },
    { company: '<a class="company-name inline-link" href="https://www.travelers.com/" rel="nofollow" target="_blank">Travelers</a>', premium: '$2,539' },
  ];

  zipRateRows = [
    { zipCode: '76301', neighborhood: "WICHITA_FALLS_HOME_TX.ZIP_NEIGHBORHOODS.Z76301", annualCost: '$2,150', highlighted: false },
    { zipCode: '76308', neighborhood: "WICHITA_FALLS_HOME_TX.ZIP_NEIGHBORHOODS.Z76308", annualCost: '$2,420', highlighted: true },
    { zipCode: '76309', neighborhood: "WICHITA_FALLS_HOME_TX.ZIP_NEIGHBORHOODS.Z76309", annualCost: '$2,650', highlighted: false },
    { zipCode: '76302', neighborhood: "WICHITA_FALLS_HOME_TX.ZIP_NEIGHBORHOODS.Z76302", annualCost: '$2,180', highlighted: true },
    { zipCode: '76306', neighborhood: "WICHITA_FALLS_HOME_TX.ZIP_NEIGHBORHOODS.Z76306", annualCost: '$2,190', highlighted: false },
    { zipCode: '76305', neighborhood: "WICHITA_FALLS_HOME_TX.ZIP_NEIGHBORHOODS.Z76305", annualCost: '$2,390', highlighted: true },
    { zipCode: '76310', neighborhood: "WICHITA_FALLS_HOME_TX.ZIP_NEIGHBORHOODS.Z76310", annualCost: '$2,520', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('WICHITA_FALLS_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('WICHITA_FALLS_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('WICHITA_FALLS_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('WICHITA_FALLS_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('WICHITA_FALLS_HOME_TX.NEIGHBORHOODS.ROWS');
  }
