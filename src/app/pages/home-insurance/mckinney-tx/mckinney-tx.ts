...
@Component({
  selector: 'app-homeowners-mckinney-tx',
  standalone: false,
  templateUrl: './mckinney-tx.html',
  styleUrl: './mckinney-tx.scss',
})
export class HomeownersMckinneyTx implements AfterViewInit {
  ...
  annualRates = [
    ...
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/" rel="nofollow" target="_blank">USAA</a>', premium: '$4,368' },
    { company: '<a class="company-name inline-link" href="https://www.chubb.com/pk-en/" rel="nofollow" target="_blank">Chubb</a>', premium: '$6,720' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', premium: '$5,016' },
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', premium: '$2,568' },
  ];

  zipRateRows = [
    { zipCode: '75069', neighborhood: 'MCKINNEY_HOME_TX.RATES.ZIP_NEIGHBORHOOD_DOWNTOWN', annualCost: '$3,380', highlighted: false },
    { zipCode: '75070', neighborhood: 'MCKINNEY_HOME_TX.RATES.ZIP_NEIGHBORHOOD_WEST', annualCost: '$3,520', highlighted: true },
    { zipCode: '75071', neighborhood: 'MCKINNEY_HOME_TX.RATES.ZIP_NEIGHBORHOOD_NORTH', annualCost: '$3,450', highlighted: false },
    { zipCode: '75072', neighborhood: 'MCKINNEY_HOME_TX.RATES.ZIP_NEIGHBORHOOD_NORTHWEST', annualCost: '$3,600', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('MCKINNEY_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('MCKINNEY_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('MCKINNEY_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('MCKINNEY_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('MCKINNEY_HOME_TX.NEIGHBORHOODS.ROWS');
  }
