...
@Component({
  selector: 'app-homeowners-pasadena-tx',
  standalone: false,
  templateUrl: './pasadena-tx.html',
  styleUrl: './pasadena-tx.scss',
})
export class HomeownersPasadenaTx implements AfterViewInit {
  ...
  annualRates = [
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', premium: '$3,150' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', premium: '$4,880' },
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/" rel="nofollow" target="_blank">USAA</a>', premium: '$3,950' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', premium: '$3,516' },
    { company: '<a class="company-name inline-link" href="https://www.chubb.com/pk-en/" rel="nofollow" target="_blank">Chubb</a>', premium: '$9,200' },
  ];

  zipRateRows = [
    { zipCode: '77502', neighborhood: 'PASADENA_HOME_TX.RATES.ZIP_NEIGHBORHOOD_CENTRAL', annualCost: '$3,350', highlighted: false },
    { zipCode: '77503', neighborhood: 'PASADENA_HOME_TX.RATES.ZIP_NEIGHBORHOOD_NORTH', annualCost: '$3,210', highlighted: true },
    { zipCode: '77504', neighborhood: 'PASADENA_HOME_TX.RATES.ZIP_NEIGHBORHOOD_WEST', annualCost: '$3,480', highlighted: false },
    { zipCode: '77505', neighborhood: 'PASADENA_HOME_TX.RATES.ZIP_NEIGHBORHOOD_SOUTH', annualCost: '$3,920', highlighted: true },
    { zipCode: '77506', neighborhood: 'PASADENA_HOME_TX.RATES.ZIP_NEIGHBORHOOD_EAST', annualCost: '$3,150', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('PASADENA_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('PASADENA_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('PASADENA_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('PASADENA_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('PASADENA_HOME_TX.NEIGHBORHOODS.ROWS');
  }
