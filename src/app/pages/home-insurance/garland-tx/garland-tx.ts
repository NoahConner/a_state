...
@Component({
  selector: 'app-homeowners-garland-tx',
  standalone: false,
  templateUrl: './garland-tx.html',
  styleUrl: './garland-tx.scss',
})
export class HomeownersGarlandTx implements AfterViewInit {
  ...
  annualRates = [
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/texas/" rel="nofollow" target="_blank">Texas Farmers</a>', premium: '$280' },
    { company: '<a class="company-name inline-link" href="https://www.altasurance.com/american-strategic-insurance/" rel="nofollow" target="_blank">ASI Lloyds</a>', premium: '$2,790' },
    ...
    { company: '<a class="company-name inline-link" href="https://www.uuinsurance.com/" rel="nofollow" target="_blank">United</a>', premium: '$3,058' },
  ];

  zipRateRows = [
    { zipCode: '75044', neighborhood: 'Buckingham', annualCost: '$3,525', highlighted: false },
    { zipCode: '75043', neighborhood: 'Centerville', annualCost: '$3,549', highlighted: true },
    { zipCode: '75040', neighborhood: 'GARLAND_HOME_TX.RATES.ZIP_NEIGHBORHOOD_DOWNTOWN', annualCost: '$3,589', highlighted: false },
    { zipCode: '75042', neighborhood: 'North Garland', annualCost: '$3,634', highlighted: true },
    { zipCode: '75041', neighborhood: 'South Garland', annualCost: '$3,615', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('GARLAND_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('GARLAND_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('GARLAND_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('GARLAND_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('GARLAND_HOME_TX.NEIGHBORHOODS.ROWS');
  }
