...
@Component({
  selector: 'app-homeowners-san-antonio-tx',
  standalone: false,
  templateUrl: './san-antonio-tx.html',
  styleUrl: './san-antonio-tx.scss',
})
export class HomeownersSanAntonioTx implements AfterViewInit {
  ...
  annualRates = [
    { company: '<a class="company-name inline-link" href="https://www.republicgroup.com/" rel="nofollow" target="_blank">Republic Indemnity</a>', premium: '$1,224' },
    { company: '<a class="company-name inline-link" href="https://www.travelers.com/" rel="nofollow" target="_blank">Travelers</a>', premium: '$1,524' },
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', premium: '$1,860' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', premium: '$1,920' },
    { company: '<a class="company-name inline-link" href="https://www.foremost.com/" rel="nofollow" target="_blank">Foremost</a>', premium: '$2,004' },
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/" rel="nofollow" target="_blank">USAA</a>', premium: '$2,052' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', premium: '$2,340' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', premium: '$2,856' },
    { company: '<a class="company-name inline-link" href="https://www.nationwide.com/" rel="nofollow" target="_blank">Nationwide</a>', premium: '$3,000' },
    { company: '<a class="company-name inline-link" href="https://www.chubb.com/" rel="nofollow" target="_blank">Chubb</a>', premium: '$4,572' },
  ];

  zipRateRows = [
    { zipCode: '78245', neighborhood: 'Far West Side', annualCost: '$2,393', highlighted: false },
    { zipCode: '78254', neighborhood: 'Alamo Ranch', annualCost: '$2,318', highlighted: true },
    { zipCode: '78251', neighborhood: 'Westover Hills', annualCost: '$2,367', highlighted: false },
    { zipCode: '78250', neighborhood: 'Northwest Crossing', annualCost: '$2,387', highlighted: true },
    { zipCode: '78253', neighborhood: 'Alamo Ranch', annualCost: '$2,356', highlighted: false },
    { zipCode: '78249', neighborhood: 'De Zavala', annualCost: '$2,419', highlighted: true },
    { zipCode: '78240', neighborhood: 'Medical Center', annualCost: '$2,388', highlighted: false },
    { zipCode: '78228', neighborhood: 'Woodlawn Hills', annualCost: '$2,319', highlighted: true },
    { zipCode: '78223', neighborhood: 'Highland Hills', annualCost: '$2,289', highlighted: false },
    { zipCode: '78207', neighborhood: 'Prospect Hill', annualCost: '$2,283', highlighted: true },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('SAN_ANTONIO_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('SAN_ANTONIO_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('SAN_ANTONIO_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('SAN_ANTONIO_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('SAN_ANTONIO_HOME_TX.NEIGHBORHOODS.ROWS');
  }
