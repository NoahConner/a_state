...
@Component({
  selector: 'app-homeowners-new-braunfels-tx',
  standalone: false,
  templateUrl: './new-braunfels-tx.html',
  styleUrl: './new-braunfels-tx.scss',
})
export class HomeownersNewBraunfelsTx implements AfterViewInit {
  ...
  annualRates = [
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/" rel="nofollow" target="_blank">USAA</a>', premium: '$2,140' },
    { company: '<a class="company-name inline-link" href="https://www.travelers.com/" rel="nofollow" target="_blank">Travelers</a>', premium: '$2,995' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', premium: '$2,840' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', premium: '$3,200' },
    { company: '<a class="company-name inline-link" href="https://www.amica.com/" rel="nofollow" target="_blank">Amica</a>', premium: '$1,555' },
    { company: '<a class="company-name inline-link" href="https://www.nationwide.com/" rel="nofollow" target="_blank">Nationwide</a>', premium: '$2,762' },
  ];

  zipRateRows = [
    { zipCode: '78130', neighborhood: "East New Braunfels", annualCost: '$137', highlighted: false },
    { zipCode: '78132', neighborhood: "West New Braunfels", annualCost: '$101', highlighted: true },
    { zipCode: '78133', neighborhood: "Canyon Lake", annualCost: '$130', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('NEW_BRAUNFELS_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('NEW_BRAUNFELS_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('NEW_BRAUNFELS_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('NEW_BRAUNFELS_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('NEW_BRAUNFELS_HOME_TX.NEIGHBORHOODS.ROWS');
  }
