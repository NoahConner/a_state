...
@Component({
  selector: 'app-homeowners-brownsville-tx',
  standalone: false,
  templateUrl: './brownsville-tx.html',
  styleUrl: './brownsville-tx.scss',
})
export class HomeownersBrownsvilleTx implements AfterViewInit {
  ...
  annualRates = [
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', premium: '$1,135' },
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/" rel="nofollow" target="_blank">USAA</a>', premium: '$1,771' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', premium: '$2,133' },
    { company: '<a class="company-name inline-link" href="https://www.travelers.com/" rel="nofollow" target="_blank">Travelers</a>', premium: '$3,013' },
    { company: '<a class="company-name inline-link" href="https://www.afi.org/" rel="nofollow" target="_blank">Armed Forces Insurance Exchange</a>', premium: '$3,219' },
    { company: '<a class="company-name inline-link" href="https://www.texasfairplan.org/" rel="nofollow" target="_blank">Texas FAIR Plan</a>', premium: '$3,228' },
  ];

  zipRateRows = [
    { zipCode: '78520', neighborhood: 'Downtown Brownsville', annualCost: '$3,369', highlighted: false },
    { zipCode: '78521', neighborhood: 'South Brownsville', annualCost: '$3,375', highlighted: true },
    { zipCode: '78522', neighborhood: 'Central Brownsville', annualCost: '$3,363', highlighted: false },
    { zipCode: '78523', neighborhood: 'North Brownsville', annualCost: '$3,456', highlighted: true },
    { zipCode: '78526', neighborhood: 'West Brownsville', annualCost: '$3,363', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('BROWNSVILLE_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('BROWNSVILLE_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('BROWNSVILLE_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('BROWNSVILLE_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('BROWNSVILLE_HOME_TX.NEIGHBORHOODS.ROWS');
  }
