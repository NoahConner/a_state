...
@Component({
  selector: 'app-homeowners-college-station-tx',
  standalone: false,
  templateUrl: './college-station-tx.html',
  styleUrl: './college-station-tx.scss',
})
export class HomeownersCollegeStationTx implements AfterViewInit {
  ...
  annualRates = [
    { company: '<a class="company-name inline-link" href="https://www.republicindemnity.com/" rel="nofollow" target="_blank">Republic Indemnity</a>', premium: '$1,404' },
    { company: '<a class="company-name inline-link" href="https://www.farmers.com/" rel="nofollow" target="_blank">Farmers</a>', premium: '$1,572' },
    { company: '<a class="company-name inline-link" href="https://www.travelers.com/" rel="nofollow" target="_blank">Travelers</a>', premium: '$1,620' },
    { company: '<a class="company-name inline-link" href="https://www.mercuryinsurance.com/" rel="nofollow" target="_blank">Mercury</a>', premium: '$1,656' },
    { company: '<a class="company-name inline-link" href="https://www.usaa.com/" rel="nofollow" target="_blank">USAA</a>', premium: '$1,656' },
    { company: '<a class="company-name inline-link" href="https://www.foremost.com/" rel="nofollow" target="_blank">Foremost</a>', premium: '$1,692' },
    { company: '<a class="company-name inline-link" href="https://www.statefarm.com/" rel="nofollow" target="_blank">State Farm</a>', premium: '$1,740' },
    { company: '<a class="company-name inline-link" href="https://www.allstate.com/" rel="nofollow" target="_blank">Allstate</a>', premium: '$1,824' },
    { company: '<a class="company-name inline-link" href="https://www.nationwide.com/" rel="nofollow" target="_blank">Nationwide</a>', premium: '$1,824' },
    { company: '<a class="company-name inline-link" href="https://www.chubb.com/pk-en/" rel="nofollow" target="_blank">Chubb</a>', premium: '$2,232' },
  ];

  zipRateRows = [
    { zipCode: '77840', neighborhood: 'Eastgate', annualCost: '$2,152', highlighted: false },
    { zipCode: '77845', neighborhood: 'Castlegate', annualCost: '$2,200', highlighted: true },
    { zipCode: '77843', neighborhood: 'A&M University Area', annualCost: '$1,700', highlighted: false },
  ];
  ...
  private buildTableOfContents() {
    const city = this.translate.instant('COLLEGE_STATION_HOME_TX.TABLE_OF_CONTENTS.LOCATION');
    ...
    this.zipCodesHeading = `${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_PREFIX')} ${this.translate.instant('COLLEGE_STATION_HOME_TX.RATES.ZIP_LOCATION_POSSESSIVE')} ${this.translate.instant('GLOBAL_HOME_TX.RATES.ZIP_CODES_HEADING_SUFFIX')}`;
    ...
    this.compareRates = [
      {
        ...
        values: [
          this.translate.instant('COLLEGE_STATION_HOME_TX.RATES.COMPARISON_CITY_VALUE'),
    ...
    this.faqItems = this.translate.instant('COLLEGE_STATION_HOME_TX.FAQ.ITEMS');
    this.neighborhoodsRows = this.translate.instant('COLLEGE_STATION_HOME_TX.NEIGHBORHOODS.ROWS');
  }
