...
@Component({
  selector: 'app-aca-marketplace-plans-insurance',
  standalone: false,
  templateUrl: './aca-marketplace-plans-insurance.html',
  styleUrl: './aca-marketplace-plans-insurance.scss',
})
export class AcaMarketplacePlansInsurance {
  termsAccepted = false;
